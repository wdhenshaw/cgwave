...
$testName="all";
$testsFile="testsWave"; # location of tests
$replace="";
$verbose=1; 
$solver=""; 
...
foreach $cmdCommand ( @cmdFiles )
{
  ...
  $checkFileName="$resultsDir/$checkFileName";   # put file in resultsDir
  $runTimeOutput="$resultsDir/$runTimeOutput";   # put file in resultsDir
