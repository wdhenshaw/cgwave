#
#  cgWaveHoltz command script: SCATTERING FROM BODIES 
# 
#     cgwh scat.cmd -g=<grid-name> -x0=<f> -y0=<f> -omega=<f> -solver=[none|fixedPoint|krylov] -tol=<f> -tp=<f> ...
...
#   -maxIterations=<>
#
$go="go"; $debug=0; $debugOges=0;
$known="planeWave";
$amp=1; $kx=1.0; $ky=0; $kz=0; $ic="zero"; $setKnownOnBoundaries=1;
#
$omega=30.1; 
