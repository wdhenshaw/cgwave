%
%  Plot convergence rate graphs for cgwave and cgWaveHoltz
%
...
caseOption = 'sineHelmholtzCIC';
% caseOption = 'planarInterface3d';
...
if( strcmp(caseOption,'sineHelmholtz')==1 )

  % -- 2D planar interface, order 2 and order4 ----
  
  Cases = { ...
           'interfaceNFDTDtwoSquaresInterfaceOrder2MLAmaxNorm', ...
           'interfaceNFDTDtwoSquaresInterfaceOrder4MLAmaxNorm', ...
           'done' };

  % initial grid spacing
  N0 = [10,10,10,10,10,10,10,10,10]*2;  % grid starts at G2
  numSubCases=2;                      % 2 files per major case (these go on a single graph)
  nCases = length(Cases)/numSubCases; % number of major cases on a single plot
...
elseif( strcmp(caseOption,'planarInterface3d')==1 )

  % Starting case -- 3D planar interface, order 2 and order4 
  %  *FINISH ME* Just duplicated cases
  nd=3; 
  Cases = { ...
           'interfaceNFDTDtwoNonBoxesInterfaceOrder2MLAmaxNorm', ...
           'interfaceNFDTDtwoNonBoxesInterfaceOrder4MLAmaxNorm', ...
           'done' };
...
elseif( strcmp(caseOption,'planarInterfaceGDM')==1 )

  % *** OLD STUFF FROM ADEGDMI***
  % ---------- PLANAR INTERFACE ----------
  
  if 1==1 
    % new July 10, 2019
    Cases = { ...
      'interfaceNFDTDtwoSquaresInterfaceOrder2GDMNp3Np2maxNorm', ...
      'interfaceNFDTDtwoSquaresInterfaceOrder2GDMNp3Np2Mode1maxNorm',...
      'interfaceNFDTDtwoSquaresInterfaceOrder4GDMNp3Np2maxNorm', ...
      'interfaceNFDTDtwoSquaresInterfaceOrder4GDMNp3Np2Mode1maxNorm',...
          ... 
      'interfaceNFDTDtwoBoxesInterfaceOrder2GDMNp2Np1maxNorm', ...
      'interfaceNFDTDtwoBoxesInterfaceOrder2GDMNp2Np1Mode1maxNorm',...
      'interfaceNFDTDtwoBoxesInterfaceOrder4GDMNp2Np1maxNorm', ...
      'interfaceNFDTDtwoBoxesInterfaceOrder4GDMNp2Np1Mode1maxNorm',...
      'done'
      };
  end

  % initial grid spacing
  N0 = [10,10,10,10,10,10,10,10,10];
  nCases = length(Cases)/4; % 4 files per case 
