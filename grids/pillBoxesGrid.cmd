...
# 
# Usage:
#    ogen [-noplot] pillBoxesGrid.cmd -factor=<> -interp=[e|i] -order=<> -ml=<> -widthX=<> -widthY=<> -widthZ=<> ...
...
# Examples:
# 
#  ogen -noplot pillBoxesGrid.cmd -prefix=threePillBoxesAngle45 -refinementBox=0 -xa=-1 -xb=1 -ya=-1.25 -yb=1.25 -za=-1 -zb=1 -angle=45 -interp=e -order=2 -factor=4 
#  ogen -noplot pillBoxesGrid.cmd -prefix=threePillBoxesAngle45 -refinementBox=0 -xa=-1 -xb=1 -ya=-1.25 -yb=1.25 -za=-1 -zb=1 -angle=45 -interp=e -order=2 -factor=8
# Order=4:
#  ogen -noplot pillBoxesGrid.cmd -prefix=threePillBoxesAngle45 -refinementBox=0 -xa=-1 -xb=1 -ya=-1.25 -yb=1.25 -za=-1 -zb=1 -angle=45 -interp=e -numGhost=3 -order=4 -factor=4 
#  ogen -noplot pillBoxesGrid.cmd -prefix=threePillBoxesAngle45 -refinementBox=0 -xa=-1 -xb=1 -ya=-1.25 -yb=1.25 -za=-1 -zb=1 -angle=45 -interp=e -numGhost=3 -order=4 -factor=8 
#  ogen -noplot pillBoxesGrid.cmd -prefix=threePillBoxesAngle45 -refinementBox=0 -xa=-1 -xb=1 -ya=-1.25 -yb=1.25 -za=-1 -zb=1 -angle=45 -interp=e -numGhost=3 -order=4 -factor=16 
#  ogen -noplot pillBoxesGrid.cmd -prefix=threePillBoxesAngle45 -refinementBox=0 -xa=-1 -xb=1 -ya=-1.25 -yb=1.25 -za=-1 -zb=1 -angle=45 -interp=e -numGhost=3 -order=4 -factor=32 
# 
$prefix="pillBoxesGrid";
...
sub convertToNurbs\
{ local($old,$new,$angle,$rotationAxis,$xShift,$yShift,$zShift,$shareFlag)=@_; \
  $cmds = "nurbs \n" . \
...
#
# --- Pill Box 1 ---
$xShift=0.; $yShift=0.5; $zShift=0.; $share1="0 0 7 0 0 0"; $share2="0 0 0 7 0 0"; 
convertToNurbs(pistonOuterRing,pillBoxRing1,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share1);
$cmds
convertToNurbs(pistonTopPatch,pillBoxTopPatch1,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share1);
$cmds
convertToNurbs(pistonBottomPatch,pillBoxBottomPatch1,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share2);
$cmds
#  -- pillbox 2
$xShift=0.; $yShift=0; $zShift=0.; $share1="0 0 8 0 0 0"; $share2="0 0 0 8 0 0"; 
convertToNurbs(pistonOuterRing,pillBoxRing2,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share1);
$cmds
convertToNurbs(pistonTopPatch,pillBoxTopPatch2,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share1);
$cmds
convertToNurbs(pistonBottomPatch,pillBoxBottomPatch2,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share2);
$cmds
#  -- pillbox 3
$xShift=0.; $yShift=-0.5; $zShift=0.; $share1="0 0 9 0 0 0"; $share2="0 0 0 9 0 0"; 
convertToNurbs(pistonOuterRing,pillBoxRing3,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share1);
$cmds
convertToNurbs(pistonTopPatch,pillBoxTopPatch3,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share1);
$cmds
convertToNurbs(pistonBottomPatch,pillBoxBottomPatch3,$angle,$rotationAxis,$xShift,$yShift,$zShift,$share2);
$cmds
#
#  Refinement box 
#
