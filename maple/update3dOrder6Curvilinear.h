...
! ===========================================================================
#beginMacro update3dOrder6Curvilinear(DIM,ORDER,ORDERINTIME,GRIDTYPE,MASK,FORCING)
...
beginLoops3d()
  ...
  #End 
    ...
    lap4hSq =     \
       ...
       + c002(i1,i2,i3)*( lap4h002i + ctt1*lap2h004i )     \
