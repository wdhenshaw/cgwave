! This file automatically generated from advWaveME.bf90 with bpp.
  subroutine advWaveME2dOrder4r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
 ...
 !...........start statement function
  ...
  parameter(noForcing           =0,twilightZoneForcing =1,userForcing         =2,helmholtzForcing    =3 )
   ...
   real uex2y4z2
   real uex2y2z4
     real cxx, cyy, czz, d200(nd1a:nd1b,nd2a:nd2b,nd3a:nd3b,0:0), d020(nd1a:nd1b,nd2a:nd2b,nd3a:nd3b,0:0), cx0, cx1, cy0, cy1, cxx0, cxx1
     real cyy0, cyy1, cxxx0, cxxx1, cyyy0, cyyy1, cxxxx0, cxxxx1, cyyyy0, cyyyy1, d200i
     real d400i, d020i, d220i, d040i, uxx, uyy, uxxxx, uxxyy, uyyyy
...
cyyyy0 = 1./(dx(1)**4); cyyyy1 = (-1/6.); 
              fv(m)=0.
               ...
               do i1=n1a,n1b
                  ...
                  un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtsq*( uxx + uyy ) + cdtPow4By12*( uxxxx + uyyyy + 2.*uxxyy )  +dtSq*fv(m)  
               end do
               end do
               end do
          else
