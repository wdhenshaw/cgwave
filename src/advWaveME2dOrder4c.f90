! This file automatically generated from advWaveME.bf90 with bpp.
  subroutine advWaveME2dOrder4c( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
...
css0 = 1.; css1 = -1/12.; 
              ...
              n3a=max(nd3a,gridIndexRange(0,2)-numGhost1);  n3b=min(nd3b,gridIndexRange(1,2)+numGhost1);
               ...
               do i1=n1a,n1b
                  ...
                  un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtsq*( lap4h )                         + cdtPow4By12*( lap2hSq )                                                       
                 end do
                 end do
                 end do
          else
