! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave2dOrder4c( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE dim=2 order=4 orderInTime=2, grid=curvilinear... t=",e10.2)') t
                end if
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*  ( uxx42(i1,i2,i3,m) + uyy42(i1,i2,i3,m) ) +cf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                 if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE dim=2 order=4 orderInTime=4, grid=curvilinear... t=",e10.2)') t
                 end if
                 ! --- TAYLOR TIME-STEPPING --- 
                 m=0 ! component number 
                 ec = 0 ! component number
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          ...
                          un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*  ( uxx42(i1,i2,i3,m) + uyy42(i1,i2,i3,m) ) + cdtsq12*( vxx22(i1,i2,i3,m) + vyy22(i1,i2,i3,m) ) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          ! v is assumed to hold Lap(u) to 2nd-order
                          ! write(*,'(" i1,i2=",2i4," uxx4=",e10.2," true=",e10.2)') i1,i2,uxx42(i1,i2,i3,m),evxx(m)
                          un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*  ( uxx42(i1,i2,i3,m) + uyy42(i1,i2,i3,m) ) + cdtsq12*( vxx22(i1,i2,i3,m) + vyy22(i1,i2,i3,m) ) +cf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( orderOfAccuracy.eq.4 .and. orderInTime.eq.2 )then
              ! FD24 : second-order in time and fourth-order in space
                if( (debug.gt.1) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE IMPLICIT dim=2 order=4 orderInTime=2, grid=curvilinear, t=",e10.2)') t
                end if
                ...
                fv(m)=0.
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- TWO DIMENSIONS ---
                       ! 2D orderInSpace==4 and orderInTime==2  IMPLICIT                                                 
                         !  --- 2D FD24i CURVLINEAR ---
                         un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m) + ts3*( uxx42(i1,i2,i3,0) +  uyy42(i1,i2,i3,0) )  + ts4*(umxx42(i1,i2,i3,0) + umyy42(i1,i2,i3,0) )  + tsf*fv(m)               
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                 ...
                 if( (debug.gt.1) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE IMPLICIT dim=2 order=4 orderInTime=4, grid=curvilinear, t=",e10.2)') t
                 end if
                 ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                 !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                 m=0 ! component number 
                 ec = 0 ! component number
                      ...
                      if( useSuperGrid==0 )then
                        ...
                        ! superGrid -- **Cartesian Grid**
                          ...
                          do i1=m1a,m1b
                          v(i1,i2,i3,0) =  etax(i1,0)*uxx22r(i1,i2,i3,0) + etax(i1,1)*ux22r(i1,i2,i3,0) + etay(i2,0)*uyy22r(i1,i2,i3,0) + etay(i2,1)*uy22r(i1,i2,i3,0)
                          v(i1,i2,i3,1) =  etax(i1,0)*umxx22r(i1,i2,i3,0) + etax(i1,1)*umx22r(i1,i2,i3,0) + etay(i2,0)*umyy22r(i1,i2,i3,0) + etay(i2,1)*umy22r(i1,i2,i3,0)
                          ! v(i1,i2,i3,0) = uxx22(i1,i2,i3,0) + uyy22(i1,i2,i3,0)
                          end do
                          end do
                          end do
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- TWO DIMENSIONS ---
                        ! 2D orderInSpace=4 and orderInTime=4 IMPLICIT
                          ...
                          !
                          un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m) + ts3*( uxx42(i1,i2,i3,0) +  uyy42(i1,i2,i3,0) )  + ts4*(umxx42(i1,i2,i3,0) + umyy42(i1,i2,i3,0) )  + ts5*( vxx22(i1,i2,i3,0) + vyy22(i1,i2,i3,0) ) + ts6*( vxx22(i1,i2,i3,1) + vyy22(i1,i2,i3,1) ) + tsf*fv(m) 
             ...
             if( orderOfAccuracy.eq.4 .and. orderInTime.eq.2 )then
              ! FD24 : second-order in time and fourth-order in space
                if( (debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=2 order=4 orderInTime=2, grid=curvilinear, t=",e10.2)') t
                end if
                ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                m=0 ! component number 
                ...
                fv(m)=0.
                  ...
                  do i1=n1a,n1b
                   ...
                   stop 5555
                     ! --- TWO DIMENSIONS ---
                       ! 2D orderInSpace==4 and orderInTime==2  IMPLICIT                                                 
                         un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m) + ts3*( uxx42(i1,i2,i3,0) +  uyy42(i1,i2,i3,0) )  + ts4*(umxx42(i1,i2,i3,0) + umyy42(i1,i2,i3,0) )  + tsf*fv(m)               
                         ! un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m) - um(i1,i2,i3,m) + (cdtSq)*( cImp( 0,0) *(  uxx42(i1,i2,i3,0) +  uyy42(i1,i2,i3,0) ) +   !                                                               cImp(-1,0) *( umxx42(i1,i2,i3,0) + umyy42(i1,i2,i3,0) ) )   !                                                   + dtSq*fv(m)                                                             
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                 ...
                 if( (debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=2 order=4 orderInTime=4, grid=curvilinear, t=",e10.2)') t
                 end if
                 ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                 !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                 m=0 ! component number 
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
           if( useSuperGrid==1 .and. gridType==curvilinear )then
             ...
             ! addUpwindDissImplicitOld(2,4,curvilinear)
               if( (.true. .or. debug.gt.3) .and. t.lt.4*dt )then
                 write(*,'(/,"advWave:addUpwindDissImplicit: UPWIND DISS dim=2 order=4 grid=curvilinear... t=",e10.2)') t
                 if( gridType==rectangular )then
                   write(*,'(" upwind-diss-coeff: adxSosup=",3(1pe12.4,1x))') adxSosup(0), adxSosup(1),adxSosup(2)
                 else
                   write(*,'(" upwind-diss-coeff: adSosup=",1pe12.4)') adSosup
         ...
         if( preComputeUpwindUt.eq.1 )then
           ! precompute Ut in upwind dissipation,  (uses v=uDot computed above)
             if( debug.gt.1 .and. t.lt.4*dt )then
               write(*,'("addUpwindDiss: UPWIND DISS using u.t=v dim=2 order=4 grid=curvilinear... t=",e10.2)') t
               if( gridType==rectangular )then
           ...
           ! compute Ut inline in Gauss-Seidel fashion (this is more stable)
             if( debug.gt.1 .and. t.lt.4*dt )then
               write(*,'("addUpwindDiss: UPWIND DISS using u.t=Dztu dim=2 order=4 grid=curvilinear... t=",e10.2)') t
               if( gridType==rectangular )then
                 write(*,'(" useSimplifiedDissipation=",i2," adxSosup=",3(1pe12.4))') useSimplifiedDissipation, adxSosup(0), adxSosup(1),adxSosup(2)
               else
                 write(*,'(" useSimplifiedDissipation=",i2," adSosup=",(1pe12.4))') useSimplifiedDissipation, adSosup
