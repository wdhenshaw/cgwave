! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave2dOrder2r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE dim=2 order=2 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
               ...
               ! #End
                   ! --- SECOND 2 ---
                     ! --- TWO DIMENSIONS ---
                       un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( uxx22r(i1,i2,i3,0) + uyy22r(i1,i2,i3,0) ) 
               ...
               ! #End
                   ...
                   ! --- SECOND 2 ---
                     ! --- TWO DIMENSIONS ---
                       un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( uxx22r(i1,i2,i3,0) + uyy22r(i1,i2,i3,0) ) +cf*fv(m)
                      ! write(*,'(" adv: i1,i2=",2i4," un,u,um=",3e12.2," cdtSq,fv=",2e12.2)') i1,i2,un(i1,i2,i3,m),u(i1,i2,i3,m),um(i1,i2,i3,m),cdtSq,fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE SUPERGRID dim=2 order=2 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
                ! --- TAYLOR TIME-STEPPING --- 
                m=0 ! component number 
                ec = 0 ! component number
               ...
               ! #End
                   ! --- SECOND 2 ---
                     ! --- TWO DIMENSIONS ---
                     un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx22r(i1,i2,i3,0) + etax(i1,1)*ux22r(i1,i2,i3,0) + etay(i2,0)*uyy22r(i1,i2,i3,0) + etay(i2,1)*uy22r(i1,i2,i3,0) ) 
                    ! write(*,'(" adv: i1,i2=",2i4," un,u,um=",3e12.2," cdtSq,fv=",2e12.2)') i1,i2,un(i1,i2,i3,m),u(i1,i2,i3,m),um(i1,i2,i3,m),cdtSq,fv(m)
               ...
               ! #End
                   ...
                   ! --- SECOND 2 ---
                     ! --- TWO DIMENSIONS ---
                     un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx22r(i1,i2,i3,0) + etax(i1,1)*ux22r(i1,i2,i3,0) + etay(i2,0)*uyy22r(i1,i2,i3,0) + etay(i2,1)*uy22r(i1,i2,i3,0) ) +cf*fv(m)
                    ! write(*,'(" adv: i1,i2=",2i4," un,u,um=",3e12.2," cdtSq,fv=",2e12.2)') i1,i2,un(i1,i2,i3,m),u(i1,i2,i3,m),um(i1,i2,i3,m),cdtSq,fv(m)
                    ! write(*,'(" adv: etax=",2e12.2," etay=",2e12.2)') etax(i1,0),etax(i1,1), etay(i2,0),etay(i2,1)
                    ! write(*,'(" adv: cn,cm,cLap,cf=",4e12.2)') cn,cm,cLap,cf
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
         ...
         if( useSuperGrid == 0 .or. gridType==curvilinear )then
               if( (debug.gt.1) .and. t.lt.2*dt )then
                 write(*,'("advWave: ADVANCE IMPLICIT dim=2 order=2 orderInTime=2, grid=rectangular, t=",e10.2)') t
               end if
               ...
               fv(m)=0.
                 ...
                 do i1=n1a,n1b
                  ...
                  ! --- SECOND 2 ---
                    ! --- TWO DIMENSIONS ---
                     un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m) + ts3*( uxx22r(i1,i2,i3,0) +  uyy22r(i1,i2,i3,0) )  + ts4*(umxx22r(i1,i2,i3,0) + umyy22r(i1,i2,i3,0) )  + tsf*fv(m)       
                ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
           ...
           !  stop 1111
               if( (debug.gt.3) .and. t.lt.2*dt )then
                 write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=2 order=2 orderInTime=2, grid=rectangular, t=",e10.2)') t
               end if
               ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
               !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
               m=0 ! component number 
               ...
               fv(m)=0.
                 ...
                 do i1=n1a,n1b
                  ...
                  ! --- SECOND 2 ---
                    ! --- TWO DIMENSIONS ---
                     un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m)                       + ts3*( etax(i1,0)*uxx22r(i1,i2,i3,0)  + etax(i1,1)*ux22r(i1,i2,i3,0)    +  etay(i2,0)*uyy22r(i1,i2,i3,0)  + etay(i2,1)*uy22r(i1,i2,i3,0) )  + ts4*( etax(i1,0)*umxx22r(i1,i2,i3,0) + etax(i1,1)*umx22r(i1,i2,i3,0)   +  etay(i2,0)*umyy22r(i1,i2,i3,0) + etay(i2,1)*umy22r(i1,i2,i3,0) ) + tsf*fv(m)   
                     ! un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) !          + cLap*( etax(i1,0)*uxx22r(i1,i2,i3,0) + etax(i1,1)*ux22r(i1,i2,i3,0) !                 + etay(i2,0)*uyy22r(i1,i2,i3,0) + etay(i2,1)*uy22r(i1,i2,i3,0) ) FV(m)   
                ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
           if( useSuperGrid==1 .and. gridType==curvilinear )then
             ...
             ! addUpwindDissImplicitOld(2,2,rectangular)
               if( (.true. .or. debug.gt.3) .and. t.lt.4*dt )then
                 write(*,'(/,"advWave:addUpwindDissImplicit: UPWIND DISS dim=2 order=2 grid=rectangular... t=",e10.2)') t
                 if( gridType==rectangular )then
               ...
               if(  solveHelmholtz==1 .and. adjustHelmholtzForUpwinding==1 )then
                 ...
                 ! Note minus sign 
                     un(i1,i2,i3,ec) = un(i1,i2,i3,ec) - ((-6.*um(i1,i2,i3,ec)+4.*(um(i1+1,i2,i3,ec)+um(i1-1,i2,i3,ec))-(um(i1+2,i2,i3,ec)+um(i1-2,i2,i3,ec)))*adxSosup(0)+(-6.*um(i1,i2,i3,ec)+4.*(um(i1,i2+1,i3,ec)+um(i1,i2-1,i3,ec))-(um(i1,i2+2,i3,ec)+um(i1,i2-2,i3,ec)))*adxSosup(1)) 
                   end if
                 end do
                 end do
                 end do
         ...
         if( preComputeUpwindUt.eq.1 )then
           ! precompute Ut in upwind dissipation,  (uses v=uDot computed above)
             if( debug.gt.1 .and. t.lt.4*dt )then
               write(*,'("addUpwindDiss: UPWIND DISS using u.t=v dim=2 order=2 grid=rectangular... t=",e10.2)') t
               if( gridType==rectangular )then
           ...
           ! compute Ut inline in Gauss-Seidel fashion (this is more stable)
             if( debug.gt.1 .and. t.lt.4*dt )then
               write(*,'("addUpwindDiss: UPWIND DISS using u.t=Dztu dim=2 order=2 grid=rectangular... t=",e10.2)') t
               if( gridType==rectangular )then
                 write(*,'(" useSimplifiedDissipation=",i2," adxSosup=",3(1pe12.4))') useSimplifiedDissipation, adxSosup(0), adxSosup(1),adxSosup(2)
               else
                 write(*,'(" useSimplifiedDissipation=",i2," adSosup=",(1pe12.4))') useSimplifiedDissipation, adSosup
