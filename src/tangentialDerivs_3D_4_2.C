...
d04=DERIV020(d02,wth,lth,dx);
d14=DERIV120(d02,wth,lth,dx);
d24=DERIV020(d22,wth,lth,dx);
d34=DERIV120(d22,wth,lth,dx);
d44=DERIV220(d22,wth,lth,dx);
...
Z[ind3(0,0,1,NU,MU,MU)] = d01+((-1.0/6.0)*(dx[1]*dx[1])*d03);
Z[ind3(0,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d13+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d31);
Z[ind3(0,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d23+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d41);
Z[ind3(0,3,1,NU,MU,MU)] = d31+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d33);
Z[ind3(0,4,1,NU,MU,MU)] = d41+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d43);
Z[ind3(0,0,2,NU,MU,MU)] = d02[J]+((-1.0/12.0)*(dx[1]*dx[1])*d04);
Z[ind3(0,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d14+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d32);
Z[ind3(0,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d24+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d42);
Z[ind3(0,3,2,NU,MU,MU)] = d32+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d34);
Z[ind3(0,4,2,NU,MU,MU)] = d42+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d44);
...
Z[ind3(1,0,1,NU,MU,MU)] = d01+((-1.0/6.0)*(dx[1]*dx[1])*d03);
Z[ind3(1,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d13+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d31);
Z[ind3(1,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d23+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d41);
Z[ind3(1,3,1,NU,MU,MU)] = d31+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d33);
Z[ind3(1,4,1,NU,MU,MU)] = d41+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d43);
Z[ind3(1,0,2,NU,MU,MU)] = d02[J]+((-1.0/12.0)*(dx[1]*dx[1])*d04);
Z[ind3(1,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d14+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d32);
Z[ind3(1,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d24+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d42);
Z[ind3(1,3,2,NU,MU,MU)] = d32+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d34);
Z[ind3(1,4,2,NU,MU,MU)] = d42+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d44);
