! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave2dOrder8r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,ipar,rpar,ierr )
   !======================================================================
             ...
             if( addForcing.eq.0 )then
               ...
               ! #End
                   ...
                   ! ---- EIGTH 8 ---
                     ! --- EIGTH-8 TWO DIMENSIONS ---
                       ! orderInSpace==8 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( uxx82r(i1,i2,i3,m) + uyy82r(i1,i2,i3,m) ) +tsf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
               ...
               ! #End
                   ! ---- EIGTH 8 ---
                     ! --- EIGTH-8 TWO DIMENSIONS ---
                       ...
                       un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( etax(i1,0)*uxx82r(i1,i2,i3,0) + etax(i1,1)*ux82r(i1,i2,i3,0)   + etay(i2,0)*uyy82r(i1,i2,i3,0) + etay(i2,1)*uy82r(i1,i2,i3,0) )                                                                                       
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! #End
                   ...
                   ! ---- EIGTH 8 ---
                     ! --- EIGTH-8 TWO DIMENSIONS ---
                       ! 2D, orderInSpace==8 and orderInTime==2   
                       un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( etax(i1,0)*uxx82r(i1,i2,i3,0) + etax(i1,1)*ux82r(i1,i2,i3,0)   + etay(i2,0)*uyy82r(i1,i2,i3,0) + etay(i2,1)*uy82r(i1,i2,i3,0) ) +tsf*fv(m)                                                                                      
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
