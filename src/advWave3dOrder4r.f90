! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave3dOrder4r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE dim=3 order=4 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
               ...
               ! #End
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap3d4(i1,i2,i3,m) 
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap3d4(i1,i2,i3,m) +cf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                 if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE dim=3 order=4 orderInTime=4, grid=rectangular... t=",e10.2)') t
                 end if
                 ! --- TAYLOR TIME-STEPPING --- 
                 m=0 ! component number 
                 ec = 0 ! component number
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap3d4(i1,i2,i3,m) + cLapSq*lap3d2pow2(i1,i2,i3,m) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap3d4(i1,i2,i3,m) + cLapSq*lap3d2pow2(i1,i2,i3,m) +cf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE SUPERGRID dim=3 order=4 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
                ! --- TAYLOR TIME-STEPPING --- 
                m=0 ! component number 
                ec = 0 ! component number
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! 3D, orderInSpace==4 and orderInTime==2                                                   
                        un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0) + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0) + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) 
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! 3D, orderInSpace==4 and orderInTime==2                                                   
                        un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0) + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0) + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) +cf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                 if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE SUPERGRID dim=3 order=4 orderInTime=4, grid=rectangular... t=",e10.2)') t
                 end if
                 ! --- TAYLOR TIME-STEPPING --- 
                 m=0 ! component number 
                 ec = 0 ! component number
                     ...
                     if( useSuperGrid==0 )then
                       ...
                       ! superGrid -- **Cartesian Grid**
                         ...
                         do i2=m2a,m2b
                         do i1=m1a,m1b
                          v(i1,i2,i3,0) = etax(i1,0)*uxx23r(i1,i2,i3,0) + etax(i1,1)*ux23r(i1,i2,i3,0) + etay(i2,0)*uyy23r(i1,i2,i3,0) + etay(i2,1)*uy23r(i1,i2,i3,0) + etaz(i3,0)*uzz23r(i1,i2,i3,0) + etaz(i3,1)*uz23r(i1,i2,i3,0)
                          ! v(i1,i2,i3,0) = uxx23(i1,i2,i3,0) + uyy23(i1,i2,i3,0) + uzz23(i1,i2,i3,0)
                         end do
                         end do
                         end do
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! 3D, orderInSpace=4 and orderInTime=4 
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0)   + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0)   + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) + cLapSq*( etax(i1,0)*vxx23r(i1,i2,i3,0) + etax(i1,1)*vx23r(i1,i2,i3,0)   + etay(i2,0)*vyy23r(i1,i2,i3,0) + etay(i2,1)*vy23r(i1,i2,i3,0)   + etaz(i3,0)*vzz23r(i1,i2,i3,0) + etaz(i3,1)*vz23r(i1,i2,i3,0) ) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! 3D, orderInSpace=4 and orderInTime=4 
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0)   + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0)   + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) + cLapSq*( etax(i1,0)*vxx23r(i1,i2,i3,0) + etax(i1,1)*vx23r(i1,i2,i3,0)   + etay(i2,0)*vyy23r(i1,i2,i3,0) + etay(i2,1)*vy23r(i1,i2,i3,0)   + etaz(i3,0)*vzz23r(i1,i2,i3,0) + etaz(i3,1)*vz23r(i1,i2,i3,0) ) +cf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( orderOfAccuracy.eq.4 .and. orderInTime.eq.2 )then
              ! FD24 : second-order in time and fourth-order in space
                if( (debug.gt.1) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE IMPLICIT dim=3 order=4 orderInTime=2, grid=rectangular, t=",e10.2)') t
                end if
                ...
                fv(m)=0.
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- THREE DIMENSIONS ---
                       ! 3D orderInSpace==4 and orderInTime==2 IMPLICIT                                                  
                         ...
                         un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) + ts2*um(i1,i2,i3,m) + ts3*(  uxx43r(i1,i2,i3,0) +  uyy43r(i1,i2,i3,0) +  uzz43r(i1,i2,i3,0) )  + ts4*( umxx43r(i1,i2,i3,0) + umyy43r(i1,i2,i3,0) + umzz43r(i1,i2,i3,0) )  + tsf*fv(m)          
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                 ...
                 if( (debug.gt.1) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE IMPLICIT dim=3 order=4 orderInTime=4, grid=rectangular, t=",e10.2)') t
                 end if
                 ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                 !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                 m=0 ! component number 
                   ...
                   do i1=n1a,n1b
                     ...
                     if( addForcing.eq.0 )then ! *wdh* Tues March 28, 2023
                       ...
                       if( damp .ne. 0. )then
                         ...
                         do mt=-1,1
                           tm = t + dt*mt
                             call ogDeriv(ep, 0,4,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),tm, ec,evxxxx(m) )
                             call ogDeriv(ep, 0,2,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),tm, ec,evxxyy(m) )
                             call ogDeriv(ep, 0,0,4,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),tm, ec,evyyyy(m) )
                             call ogDeriv(ep, 0,2,0,2, xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),tm, ec,evxxzz(m) )
                             call ogDeriv(ep, 0,0,2,2, xy(i1,i2,i3,0),xy(i1,i2,i3,1),xy(i1,i2,i3,2),tm, ec,evyyzz(m) )
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- THREE DIMENSIONS ---
                        ! 3D orderInSpace=4 and orderInTime=4 IMPLICIT
                          ...
                          un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m) + ts3*( uxx43r(i1,i2,i3,0) +  uyy43r(i1,i2,i3,0) +  uzz43r(i1,i2,i3,0) )  + ts4*(umxx43r(i1,i2,i3,0) + umyy43r(i1,i2,i3,0) + umzz43r(i1,i2,i3,0) )  + ts5*( (6.*u(i1,i2,i3,0)-4.*(u(i1+1,i2,i3,0)+u(i1-1,i2,i3,0))+(u(i1+2,i2,i3,0)+u(i1-2,i2,i3,0)))*dxi4+(+6.*u(i1,i2,i3,0)-4.*(u(i1,i2+1,i3,0)+u(i1,i2-1,i3,0))+(u(i1,i2+2,i3,0)+u(i1,i2-2,i3,0)))*dyi4+(+6.*u(i1,i2,i3,0)-4.*(u(i1,i2,i3+1,0)+u(i1,i2,i3-1,0))+(u(i1,i2,i3+2,0)+u(i1,i2,i3-2,0)))*dzi4+(8.*u(i1,i2,i3,0)-4.*(u(i1+1,i2,i3,0)+u(i1-1,i2,i3,0)+u(i1,i2+1,i3,0)+u(i1,i2-1,i3,0))+2.*(u(i1+1,i2+1,i3,0)+u(i1-1,i2+1,i3,0)+u(i1+1,i2-1,i3,0)+u(i1-1,i2-1,i3,0)))*dxdyi2+(8.*u(i1,i2,i3,0)-4.*(u(i1+1,i2,i3,0)+u(i1-1,i2,i3,0)+u(i1,i2,i3+1,0)+u(i1,i2,i3-1,0))+2.*(u(i1+1,i2,i3+1,0)+u(i1-1,i2,i3+1,0)+u(i1+1,i2,i3-1,0)+u(i1-1,i2,i3-1,0)))*dxdzi2+(8.*u(i1,i2,i3,0)-4.*(u(i1,i2+1,i3,0)+u(i1,i2-1,i3,0)+u(i1,i2,i3+1,0)+u(i1,i2,i3-1,0))+2.*(u(i1,i2+1,i3+1,0)+u(i1,i2-1,i3+1,0)+u(i1,i2+1,i3-1,0)+u(i1,i2-1,i3-1,0)))*dydzi2 ) + ts6*( (6.*um(i1,i2,i3,0)-4.*(um(i1+1,i2,i3,0)+um(i1-1,i2,i3,0))+(um(i1+2,i2,i3,0)+um(i1-2,i2,i3,0)))*dxi4+(+6.*um(i1,i2,i3,0)-4.*(um(i1,i2+1,i3,0)+um(i1,i2-1,i3,0))+(um(i1,i2+2,i3,0)+um(i1,i2-2,i3,0)))*dyi4+(+6.*um(i1,i2,i3,0)-4.*(um(i1,i2,i3+1,0)+um(i1,i2,i3-1,0))+(um(i1,i2,i3+2,0)+um(i1,i2,i3-2,0)))*dzi4+(8.*um(i1,i2,i3,0)-4.*(um(i1+1,i2,i3,0)+um(i1-1,i2,i3,0)+um(i1,i2+1,i3,0)+um(i1,i2-1,i3,0))+2.*(um(i1+1,i2+1,i3,0)+um(i1-1,i2+1,i3,0)+um(i1+1,i2-1,i3,0)+um(i1-1,i2-1,i3,0)))*dxdyi2+(8.*um(i1,i2,i3,0)-4.*(um(i1+1,i2,i3,0)+um(i1-1,i2,i3,0)+um(i1,i2,i3+1,0)+um(i1,i2,i3-1,0))+2.*(um(i1+1,i2,i3+1,0)+um(i1-1,i2,i3+1,0)+um(i1+1,i2,i3-1,0)+um(i1-1,i2,i3-1,0)))*dxdzi2+(8.*um(i1,i2,i3,0)-4.*(um(i1,i2+1,i3,0)+um(i1,i2-1,i3,0)+um(i1,i2,i3+1,0)+um(i1,i2,i3-1,0))+2.*(um(i1,i2+1,i3+1,0)+um(i1,i2-1,i3+1,0)+um(i1,i2+1,i3-1,0)+um(i1,i2-1,i3-1,0)))*dydzi2 ) + tsf*fv(m)  
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( orderOfAccuracy.eq.4 .and. orderInTime.eq.2 )then
              ! FD24 : second-order in time and fourth-order in space
                if( (debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=3 order=4 orderInTime=2, grid=rectangular, t=",e10.2)') t
                end if
                ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                m=0 ! component number 
                ...
                fv(m)=0.
                  ...
                  do i1=n1a,n1b
                   ...
                   ! --- -FOURTH 4 ---
                   write(*,'(" IMPLICIT RHS 4 = 4 + SUPER GRID : FINISH ME")') 
                   stop 5555
                     ! --- THREE DIMENSIONS ---
                       ! 3D orderInSpace==4 and orderInTime==2 IMPLICIT                                                  
                         un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) + ts2*um(i1,i2,i3,m) + ts3*(  uxx43r(i1,i2,i3,0) +  uyy43r(i1,i2,i3,0) +  uzz43r(i1,i2,i3,0) )  + ts4*( umxx43r(i1,i2,i3,0) + umyy43r(i1,i2,i3,0) + umzz43r(i1,i2,i3,0) )  + tsf*fv(m)          
                         ! un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m) - um(i1,i2,i3,m) + (cdtSq)*( cImp( 0,0) *( uxx43r(i1,i2,i3,0) +  uyy43r(i1,i2,i3,0) +  uzz43r(i1,i2,i3,0) ) +  !                                                               cImp(-1,0) *(umxx43r(i1,i2,i3,0) + umyy43r(i1,i2,i3,0) + umzz43r(i1,i2,i3,0) ) )  !                                                   + dtSq*fv(m)         
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                 ...
                 if( (debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=3 order=4 orderInTime=4, grid=rectangular, t=",e10.2)') t
                 end if
                 ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                 !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                 m=0 ! component number 
                 ...
                 fv(m)=0.
                   ...
                   do i1=n1a,n1b
                    ...
                    stop 5555
                      ! --- THREE DIMENSIONS ---
                        ! 3D orderInSpace=4 and orderInTime=4 IMPLICIT
                          write(*,'("advWave: finish me for IMPLICIT order=4, dim=3")')
                          stop 4444
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
           if( useSuperGrid==1 .and. gridType==curvilinear )then
             ...
             ! addUpwindDissImplicitOld(3,4,rectangular)
               if( (.true. .or. debug.gt.3) .and. t.lt.4*dt )then
                 write(*,'(/,"advWave:addUpwindDissImplicit: UPWIND DISS dim=3 order=4 grid=rectangular... t=",e10.2)') t
                 if( gridType==rectangular )then
               ...
               if(  solveHelmholtz==1 .and. adjustHelmholtzForUpwinding==1 )then
                 ...
                 ! Note minus sign 
                     un(i1,i2,i3,ec) = un(i1,i2,i3,ec) - ((-20.*um(i1,i2,i3,ec)+15.*(um(i1+1,i2,i3,ec)+um(i1-1,i2,i3,ec))-6.*(um(i1+2,i2,i3,ec)+um(i1-2,i2,i3,ec))+(um(i1+3,i2,i3,ec)+um(i1-3,i2,i3,ec)))*adxSosup(0)+(-20.*um(i1,i2,i3,ec)+15.*(um(i1,i2+1,i3,ec)+um(i1,i2-1,i3,ec))-6.*(um(i1,i2+2,i3,ec)+um(i1,i2-2,i3,ec))+(um(i1,i2+3,i3,ec)+um(i1,i2-3,i3,ec)))*adxSosup(1)+(-20.*um(i1,i2,i3,ec)+15.*(um(i1,i2,i3+1,ec)+um(i1,i2,i3-1,ec))-6.*(um(i1,i2,i3+2,ec)+um(i1,i2,i3-2,ec))+(um(i1,i2,i3+3,ec)+um(i1,i2,i3-3,ec)))*adxSosup(2)) 
                   end if
                 end do
                 end do
                 end do
         ...
         if( preComputeUpwindUt.eq.1 )then
           ! precompute Ut in upwind dissipation,  (uses v=uDot computed above)
             if( debug.gt.1 .and. t.lt.4*dt )then
               write(*,'("addUpwindDiss: UPWIND DISS using u.t=v dim=3 order=4 grid=rectangular... t=",e10.2)') t
               if( gridType==rectangular )then
             ...
             ! beginLoops(i1,i2,i3,n1a,n1b,n2a,n2b,n3a,n3b)
               ...
               do i1=n1a,n1b
                ...
                ! --- -FOURTH 4 ---
                  ! --- THREE DIMENSIONS ---
                    un(i1,i2,i3,ec)=un(i1,i2,i3,ec)+((-20.*v(i1,i2,i3,ec)+15.*(v(i1+1,i2,i3,ec)+v(i1-1,i2,i3,ec))-6.*(v(i1+2,i2,i3,ec)+v(i1-2,i2,i3,ec))+(v(i1+3,i2,i3,ec)+v(i1-3,i2,i3,ec)))*adxSosup(0)+(-20.*v(i1,i2,i3,ec)+15.*(v(i1,i2+1,i3,ec)+v(i1,i2-1,i3,ec))-6.*(v(i1,i2+2,i3,ec)+v(i1,i2-2,i3,ec))+(v(i1,i2+3,i3,ec)+v(i1,i2-3,i3,ec)))*adxSosup(1)+(-20.*v(i1,i2,i3,ec)+15.*(v(i1,i2,i3+1,ec)+v(i1,i2,i3-1,ec))-6.*(v(i1,i2,i3+2,ec)+v(i1,i2,i3-2,ec))+(v(i1,i2,i3+3,ec)+v(i1,i2,i3-3,ec)))*adxSosup(2))
                 end if
               end do
               end do
               end do
           ...
           ! compute Ut inline in Gauss-Seidel fashion (this is more stable)
             if( debug.gt.1 .and. t.lt.4*dt )then
               write(*,'("addUpwindDiss: UPWIND DISS using u.t=Dztu dim=3 order=4 grid=rectangular... t=",e10.2)') t
               if( gridType==rectangular )then
                 write(*,'(" useSimplifiedDissipation=",i2," adxSosup=",3(1pe12.4))') useSimplifiedDissipation, adxSosup(0), adxSosup(1),adxSosup(2)
               else
                 write(*,'(" useSimplifiedDissipation=",i2," adSosup=",(1pe12.4))') useSimplifiedDissipation, adSosup
             ...
             ! beginLoops(i1,i2,i3,n1a,n1b,n2a,n2b,n3a,n3b)
               ...
               do i1=n1a,n1b
                ...
                ! --- -FOURTH 4 ---
                  ! --- THREE DIMENSIONS ---
                    un(i1,i2,i3,ec)=un(i1,i2,i3,ec)+((-20.*Dztu(i1,i2,i3,ec)+15.*(Dztu(i1+1,i2,i3,ec)+Dztu(i1-1,i2,i3,ec))-6.*(Dztu(i1+2,i2,i3,ec)+Dztu(i1-2,i2,i3,ec))+(Dztu(i1+3,i2,i3,ec)+Dztu(i1-3,i2,i3,ec)))*adxSosup(0)+(-20.*Dztu(i1,i2,i3,ec)+15.*(Dztu(i1,i2+1,i3,ec)+Dztu(i1,i2-1,i3,ec))-6.*(Dztu(i1,i2+2,i3,ec)+Dztu(i1,i2-2,i3,ec))+(Dztu(i1,i2+3,i3,ec)+Dztu(i1,i2-3,i3,ec)))*adxSosup(1)+(-20.*Dztu(i1,i2,i3,ec)+15.*(Dztu(i1,i2,i3+1,ec)+Dztu(i1,i2,i3-1,ec))-6.*(Dztu(i1,i2,i3+2,ec)+Dztu(i1,i2,i3-2,ec))+(Dztu(i1,i2,i3+3,ec)+Dztu(i1,i2,i3-3,ec)))*adxSosup(2))
                 end if
               end do
               end do
               end do
