! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave3dOrder4r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
             ...
             if( addForcing.eq.0 )then
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*lap3d4(i1,i2,i3,m) 
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*lap3d4(i1,i2,i3,m) +tsf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*lap3d4(i1,i2,i3,m) + cdtsq12*lap3d2pow2(i1,i2,i3,m) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*lap3d4(i1,i2,i3,m) + cdtsq12*lap3d2pow2(i1,i2,i3,m) +tsf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! 3D, orderInSpace==4 and orderInTime==2                                                   
                        un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m) - um(i1,i2,i3,m) + (cdtSq)*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0) + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0) + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) 
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOURTH-4 THREE DIMENSIONS ---
                       ! 3D, orderInSpace==4 and orderInTime==2                                                   
                        un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m) - um(i1,i2,i3,m) + (cdtSq)*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0) + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0) + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) +tsf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! 3D, orderInSpace=4 and orderInTime=4 
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m) - um(i1,i2,i3,m) + (cdtSq)*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0)   + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0)   + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) + cdtsq12*( etax(i1,0)*vxx23r(i1,i2,i3,0) + etax(i1,1)*vx23r(i1,i2,i3,0)   + etay(i2,0)*vyy23r(i1,i2,i3,0) + etay(i2,1)*vy23r(i1,i2,i3,0)   + etaz(i3,0)*vzz23r(i1,i2,i3,0) + etaz(i3,1)*vz23r(i1,i2,i3,0) ) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOURTH-4 THREE DIMENSIONS ---
                        ! 3D, orderInSpace=4 and orderInTime=4 
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m) - um(i1,i2,i3,m) + (cdtSq)*( etax(i1,0)*uxx43r(i1,i2,i3,0) + etax(i1,1)*ux43r(i1,i2,i3,0)   + etay(i2,0)*uyy43r(i1,i2,i3,0) + etay(i2,1)*uy43r(i1,i2,i3,0)   + etaz(i3,0)*uzz43r(i1,i2,i3,0) + etaz(i3,1)*uz43r(i1,i2,i3,0) ) + cdtsq12*( etax(i1,0)*vxx23r(i1,i2,i3,0) + etax(i1,1)*vx23r(i1,i2,i3,0)   + etay(i2,0)*vyy23r(i1,i2,i3,0) + etay(i2,1)*vy23r(i1,i2,i3,0)   + etaz(i3,0)*vzz23r(i1,i2,i3,0) + etaz(i3,1)*vz23r(i1,i2,i3,0) ) +tsf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
             if( (.true. .or. debug.gt.3) .and. t.lt.2*dt )then
               write(*,'("addUpwindDissImplicit: UPWIND DISS dim=3 order=4 grid=rectangular... t=",e10.2)') t
