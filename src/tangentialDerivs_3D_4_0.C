...
d44=DERIV022(d22,wth,lth,dx);
Z[ind3(0,1,0,NU,MU,MU)] = d10+((-1.0/6.0)*(dx[1]*dx[1])*d30);
Z[ind3(0,2,0,NU,MU,MU)] = d20[J]+((-1.0/12.0)*(dx[1]*dx[1])*d40);
Z[ind3(0,3,0,NU,MU,MU)] = d30;
Z[ind3(0,4,0,NU,MU,MU)] = d40;
Z[ind3(0,0,1,NU,MU,MU)] = d01+((-1.0/6.0)*(dx[2]*dx[2])*d03);
Z[ind3(0,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d13+(-1.0/6.0)*1.0*(dx[1]*dx[1])*(1.0)*d31);
Z[ind3(0,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d23+(-1.0/12.0)*1.0*(dx[1]*dx[1])*(1.0)*d41);
...
Z[ind3(0,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d14+(-1.0/6.0)*1.0*(dx[1]*dx[1])*(1.0)*d32);
Z[ind3(0,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d24+(-1.0/12.0)*1.0*(dx[1]*dx[1])*(1.0)*d42);
...
Z[ind3(0,1,3,NU,MU,MU)] = d13+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d33);
Z[ind3(0,2,3,NU,MU,MU)] = d23+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d43);
Z[ind3(0,3,3,NU,MU,MU)] = d33;
Z[ind3(0,4,3,NU,MU,MU)] = d43;
Z[ind3(0,0,4,NU,MU,MU)] = d04;
Z[ind3(0,1,4,NU,MU,MU)] = d14+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d34);
Z[ind3(0,2,4,NU,MU,MU)] = d24+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d44);
...
d34=DERIV012(d22,wth,lth,dx);
d44=DERIV022(d22,wth,lth,dx);
Z[ind3(1,1,0,NU,MU,MU)] = d10+((-1.0/6.0)*(dx[1]*dx[1])*d30);
Z[ind3(1,2,0,NU,MU,MU)] = d20[J]+((-1.0/12.0)*(dx[1]*dx[1])*d40);
Z[ind3(1,3,0,NU,MU,MU)] = d30;
Z[ind3(1,4,0,NU,MU,MU)] = d40;
Z[ind3(1,0,1,NU,MU,MU)] = d01+((-1.0/6.0)*(dx[2]*dx[2])*d03);
Z[ind3(1,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d13+(-1.0/6.0)*1.0*(dx[1]*dx[1])*(1.0)*d31);
Z[ind3(1,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d23+(-1.0/12.0)*1.0*(dx[1]*dx[1])*(1.0)*d41);
...
Z[ind3(1,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d14+(-1.0/6.0)*1.0*(dx[1]*dx[1])*(1.0)*d32);
Z[ind3(1,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d24+(-1.0/12.0)*1.0*(dx[1]*dx[1])*(1.0)*d42);
...
Z[ind3(1,1,3,NU,MU,MU)] = d13+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d33);
Z[ind3(1,2,3,NU,MU,MU)] = d23+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d43);
Z[ind3(1,3,3,NU,MU,MU)] = d33;
Z[ind3(1,4,3,NU,MU,MU)] = d43;
Z[ind3(1,0,4,NU,MU,MU)] = d04;
Z[ind3(1,1,4,NU,MU,MU)] = d14+(1.0*(-1.0/6.0)*(1.0)*(dx[1]*dx[1])*d34);
Z[ind3(1,2,4,NU,MU,MU)] = d24+(1.0*(-1.0/12.0)*(1.0)*(dx[1]*dx[1])*d44);
