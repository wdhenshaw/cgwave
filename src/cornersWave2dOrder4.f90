! This file automatically generated from cornersWave.bf90 with bpp.
 subroutine cornersWave2dOrder4( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange,dimRange,isPeriodic,u,un,mask,rsxy,xy,uTemp,v,boundaryCondition,frequencyArray,pdb,ipar,rpar,ierr )
 ! ===================================================================================
 ...
 !! #Include "../include/declareGetFourthDerivativesMacrosVariables.h"
  ...
  tz(i1,i2,i3)=rsxy(i1,i2,i3,2,2)
   ...
   ! write(*,'(" cornersWave2dOrder4: dim=2, order=4")')
