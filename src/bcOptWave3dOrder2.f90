! This file automatically generated from bcOptWave.bf90 with bpp.
 subroutine bcOptWave3dOrder2( nd,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,gridIndexRange,dimRange,isPeriodic,u,un,mask,rsxy,xy,uTemp,v,boundaryCondition,frequencyArray,pdb,ipar,rpar,ierr )
 ! ===================================================================================
...
real uzzzz
  ...
  tz(i1,i2,i3)=rsxy(i1,i2,i3,2,2)
   ...
   ! write(*,'(" bcOptWave3dOrder2: dim=3, order=2")')
