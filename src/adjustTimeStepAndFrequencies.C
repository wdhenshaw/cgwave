// This file automatically generated from adjustTimeStepAndFrequencies.bC with bpp.
#include "CgWave.h"
#include "display.h"
    ...
    // ---- adjust the scheme or omega to remove time-discretization errors -----
      ...
      // }
       ...
       // Adjustment for damping with explicit time-stepping 
              ...
              for( int freq=0; freq<numberOfFrequencies; freq++ )
              {
                  printF("#### CgWave::advance: freq=%d dt=%16.8e, omega=%14.6e omegaAdjusted=%14.6e\n",freq,dts,frequencyArraySave(freq),frequencyArray(freq));
              }
