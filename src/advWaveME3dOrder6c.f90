! This file automatically generated from advWaveME.bf90 with bpp.
    subroutine advWaveME3dOrder6c( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,fa,v,vh,lapCoeff,bc,frequencyArray,ipar,rpar,ierr )
  ! subroutine advWaveME3dOrder6c(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,!                 mask,xy,rsxy,  um,u,un, f,fa, v, vh,  bc, frequencyArray, ipar, rpar, ierr )
 !======================================================================
  ...
  ! };
    ...
    parameter(noForcing           =0,twilightZoneForcing =1,userForcing         =2,helmholtzForcing    =3 )
      ...
      real uex2y2z4
          ...
          real rz, sx, sy, sz, tx, ty, tz, rxi1g(-5:5), rxi2g(-5:5), rxi3g(-5:5), rxr
     ...
     ! ------- EXPLIICT update the solution ---------
        ...
        ! FD26 : second-order in time and sixth-order in space
                    if( ( .true. .or. debug.gt.3) .and. t.lt.2*dt )then
                        write(*,'("advWaveME: ADVANCE dim=3 order=6 orderInTime=2, grid=curvilinear... t=",e10.2)') t
                    end if
                    m=0 ! component number 
                    ec = 0 ! component number 
          ! -- call the appropriate macro:
          !  update2dOrder2Rectangular(3,6,2,curvilinear)
          !  update3dOrder6Curvilinear(3,6,2,curvilinear)
...
ctttt0 = 1.; ctttt1 = -1/6.; ctttt2 = 7/240.; 
                ...
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            ...
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),0,0)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),0,0)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),0,0)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),0,0)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),0,0))
                                        end if
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),0,0)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),0,0)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),0,0)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),0,0)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),0,0))
                                        end if
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),0,0)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),0,0)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),0,0)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),0,0)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),0,0))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,0,0)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),0,0)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),0,0)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),0,0)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),0,0)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),0,0))
                                        end if
                                        end do
                                rxr = ( 45.*(rsxy(i1+1,i2,i3,0,0)-rsxy(i1-1,i2,i3,0,0)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                rxs = ( 45.*(rsxy(i1,i2+1,i3,0,0)-rsxy(i1,i2-1,i3,0,0)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                rxt = ( 45.*(rsxy(i1,i2,i3+1,0,0)-rsxy(i1,i2,i3-1,0,0)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,0,1)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),0,1)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),0,1)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),0,1)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),0,1)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),0,1))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,0,1)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),0,1)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),0,1)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),0,1)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),0,1)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),0,1))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,0,1)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),0,1)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),0,1)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),0,1)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),0,1)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),0,1))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,0,1)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),0,1)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),0,1)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),0,1)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),0,1)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),0,1))
                                        end if
                                        end do
                                ryr = ( 45.*(rsxy(i1+1,i2,i3,0,1)-rsxy(i1-1,i2,i3,0,1)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                rys = ( 45.*(rsxy(i1,i2+1,i3,0,1)-rsxy(i1,i2-1,i3,0,1)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                ryt = ( 45.*(rsxy(i1,i2,i3+1,0,1)-rsxy(i1,i2,i3-1,0,1)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,0,2)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),0,2)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),0,2)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),0,2)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),0,2)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),0,2))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,0,2)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),0,2)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),0,2)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),0,2)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),0,2)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),0,2))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,0,2)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),0,2)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),0,2)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),0,2)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),0,2)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),0,2))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,0,2)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),0,2)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),0,2)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),0,2)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),0,2)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),0,2))
                                        end if
                                        end do
                                rzr = ( 45.*(rsxy(i1+1,i2,i3,0,2)-rsxy(i1-1,i2,i3,0,2)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                rzs = ( 45.*(rsxy(i1,i2+1,i3,0,2)-rsxy(i1,i2-1,i3,0,2)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                rzt = ( 45.*(rsxy(i1,i2,i3+1,0,2)-rsxy(i1,i2,i3-1,0,2)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,1,0)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),1,0)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),1,0)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),1,0)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),1,0)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),1,0))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,1,0)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),1,0)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),1,0)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),1,0)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),1,0)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),1,0))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,1,0)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),1,0)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),1,0)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),1,0)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),1,0)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),1,0))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,1,0)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),1,0)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),1,0)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),1,0)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),1,0)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),1,0))
                                        end if
                                        end do
                                sxr = ( 45.*(rsxy(i1+1,i2,i3,1,0)-rsxy(i1-1,i2,i3,1,0)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                sxs = ( 45.*(rsxy(i1,i2+1,i3,1,0)-rsxy(i1,i2-1,i3,1,0)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                sxt = ( 45.*(rsxy(i1,i2,i3+1,1,0)-rsxy(i1,i2,i3-1,1,0)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,1,1)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),1,1)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),1,1)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),1,1)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),1,1)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),1,1))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,1,1)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),1,1)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),1,1)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),1,1)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),1,1)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),1,1))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,1,1)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),1,1)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),1,1)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),1,1)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),1,1)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),1,1))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,1,1)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),1,1)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),1,1)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),1,1)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),1,1)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),1,1))
                                        end if
                                        end do
                                syr = ( 45.*(rsxy(i1+1,i2,i3,1,1)-rsxy(i1-1,i2,i3,1,1)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                sys = ( 45.*(rsxy(i1,i2+1,i3,1,1)-rsxy(i1,i2-1,i3,1,1)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                syt = ( 45.*(rsxy(i1,i2,i3+1,1,1)-rsxy(i1,i2,i3-1,1,1)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,1,2)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),1,2)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),1,2)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),1,2)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),1,2)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),1,2))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,1,2)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),1,2)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),1,2)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),1,2)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),1,2)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),1,2))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,1,2)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),1,2)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),1,2)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),1,2)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),1,2)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),1,2))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,1,2)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),1,2)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),1,2)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),1,2)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),1,2)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),1,2))
                                        end if
                                        end do
                                szr = ( 45.*(rsxy(i1+1,i2,i3,1,2)-rsxy(i1-1,i2,i3,1,2)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                szs = ( 45.*(rsxy(i1,i2+1,i3,1,2)-rsxy(i1,i2-1,i3,1,2)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                szt = ( 45.*(rsxy(i1,i2,i3+1,1,2)-rsxy(i1,i2,i3-1,1,2)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,2,0)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),2,0)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),2,0)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),2,0)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),2,0)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),2,0))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,2,0)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),2,0)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),2,0)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),2,0)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),2,0)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),2,0))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,2,0)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),2,0)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),2,0)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),2,0)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),2,0)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),2,0))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,2,0)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),2,0)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),2,0)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),2,0)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),2,0)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),2,0))
                                        end if
                                        end do
                                txr = ( 45.*(rsxy(i1+1,i2,i3,2,0)-rsxy(i1-1,i2,i3,2,0)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                txs = ( 45.*(rsxy(i1,i2+1,i3,2,0)-rsxy(i1,i2-1,i3,2,0)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                txt = ( 45.*(rsxy(i1,i2,i3+1,2,0)-rsxy(i1,i2,i3-1,2,0)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,2,1)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),2,1)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),2,1)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),2,1)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),2,1)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),2,1))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,2,1)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),2,1)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),2,1)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),2,1)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),2,1)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),2,1))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,2,1)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),2,1)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),2,1)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),2,1)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),2,1)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),2,1))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,2,1)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),2,1)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),2,1)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),2,1)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),2,1)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),2,1))
                                        end if
                                        end do
                                tyr = ( 45.*(rsxy(i1+1,i2,i3,2,1)-rsxy(i1-1,i2,i3,2,1)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                tys = ( 45.*(rsxy(i1,i2+1,i3,2,1)-rsxy(i1,i2-1,i3,2,1)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                tyt = ( 45.*(rsxy(i1,i2,i3+1,2,1)-rsxy(i1,i2,i3-1,2,1)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
                ! --- get neighbours of metrics for computing derivatives, extrapolate if necessary ---
                                    do ig=2,4
                                        if( i1-ig.ge.nd1a )then
                                            rxi1g(-ig) = rsxy(i1-ig,i2,i3,2,2)
                                        else
                                            rxi1g(-ig) = (5.*rsxy(i1-ig+(1),i2+(0),i3+(0),2,2)-10.*rsxy(i1-ig+2*(1),i2+2*(0),i3+2*(0),2,2)+10.*rsxy(i1-ig+3*(1),i2+3*(0),i3+3*(0),2,2)-5.*rsxy(i1-ig+4*(1),i2+4*(0),i3+4*(0),2,2)+rsxy(i1-ig+5*(1),i2+5*(0),i3+5*(0),2,2))
                                        end if
                                        if( i1+ig.le.nd1b )then
                                            rxi1g(+ig) = rsxy(i1+ig,i2,i3,2,2)
                                        else
                                        ...
                                        if( i2-ig.ge.nd2a )then
                                            ...
                                            rxi2g(-ig) = (5.*rsxy(i1+(0),i2-ig+(1),i3+(0),2,2)-10.*rsxy(i1+2*(0),i2-ig+2*(1),i3+2*(0),2,2)+10.*rsxy(i1+3*(0),i2-ig+3*(1),i3+3*(0),2,2)-5.*rsxy(i1+4*(0),i2-ig+4*(1),i3+4*(0),2,2)+rsxy(i1+5*(0),i2-ig+5*(1),i3+5*(0),2,2))
                                        end if
                                        if( i2+ig.le.nd2b )then
                                            rxi2g(+ig) = rsxy(i1,i2+ig,i3,2,2)
                                        else
                                        ...
                                        if( i3-ig.ge.nd3a )then
                                            ...
                                            rxi3g(-ig) = (5.*rsxy(i1+(0),i2+(0),i3-ig+(1),2,2)-10.*rsxy(i1+2*(0),i2+2*(0),i3-ig+2*(1),2,2)+10.*rsxy(i1+3*(0),i2+3*(0),i3-ig+3*(1),2,2)-5.*rsxy(i1+4*(0),i2+4*(0),i3-ig+4*(1),2,2)+rsxy(i1+5*(0),i2+5*(0),i3-ig+5*(1),2,2))
                                        end if
                                        if( i3+ig.le.nd3b )then
                                            rxi3g(+ig) = rsxy(i1,i2,i3+ig,2,2)
                                        else
                                            rxi3g(+ig) = (5.*rsxy(i1+(0),i2+(0),i3+(-1),2,2)-10.*rsxy(i1+2*(0),i2+2*(0),i3+2*(-1),2,2)+10.*rsxy(i1+3*(0),i2+3*(0),i3+3*(-1),2,2)-5.*rsxy(i1+4*(0),i2+4*(0),i3+4*(-1),2,2)+rsxy(i1+5*(0),i2+5*(0),i3+5*(-1),2,2))
                                        end if
                                        end do
                                tzr = ( 45.*(rsxy(i1+1,i2,i3,2,2)-rsxy(i1-1,i2,i3,2,2)) -9.*(rxi1g(2)-rxi1g(-2)) +(rxi1g(3)-rxi1g(-3)) )*(dr1i/60.) 
                                tzs = ( 45.*(rsxy(i1,i2+1,i3,2,2)-rsxy(i1,i2-1,i3,2,2)) -9.*(rxi2g(2)-rxi2g(-2)) +(rxi2g(3)-rxi2g(-3)) )*(dr2i/60.) 
                                tzt = ( 45.*(rsxy(i1,i2,i3+1,2,2)-rsxy(i1,i2,i3-1,2,2)) -9.*(rxi3g(2)-rxi3g(-2)) +(rxi3g(3)-rxi3g(-3)) )*(dr3i/60.) 
            ...
            ! ===========  FINAL LOOP TO FILL IN THE SOLUTION ============
                ...
                ! --- Laplacian to order 6 = lap4h + corrections 
                                lap6h = lap4h(i1,i2,i3,0) + lapCoeff(i1,i2,i3,0)*crr2*d600i + lapCoeff(i1,i2,i3,1)*css2*d060i + lapCoeff(i1,i2,i3,2)*ctt2*d006i + lapCoeff(i1,i2,i3,3)*(cr2*d510i + cs2*d150i + cr1*cs1*d330i ) + lapCoeff(i1,i2,i3,4)*(cr2*d501i + ct2*d105i + cr1*ct1*d303i ) + lapCoeff(i1,i2,i3,5)*(cs2*d051i + ct2*d015i + cs1*ct1*d033i ) + lapCoeff(i1,i2,i3,6)*cr2 *d500i + lapCoeff(i1,i2,i3,7)*cs2 *d050i + lapCoeff(i1,i2,i3,8)*ct2 *d005i 
                                ...
                                lap2hCubed =  + lapCoeff(i1,i2,i3,0)*lap2hSq200i + lapCoeff(i1,i2,i3,1)*lap2hSq020i + lapCoeff(i1,i2,i3,2)*lap2hSq002i + lapCoeff(i1,i2,i3,3)*lap2hSq110i  + lapCoeff(i1,i2,i3,4)*lap2hSq101i  + lapCoeff(i1,i2,i3,5)*lap2hSq011i  + lapCoeff(i1,i2,i3,6)*lap2hSq100i  + lapCoeff(i1,i2,i3,7)*lap2hSq010i  + lapCoeff(i1,i2,i3,8)*lap2hSq001i   
                ...
                !  lap2h*( lap4h ) + corrections*( Lap2h )
                                ...
                                lap4hSq =     lapCoeff(i1,i2,i3,0)*( lap4h200i + crr1*lap2h400i )    + lapCoeff(i1,i2,i3,1)*( lap4h020i + css1*lap2h040i )     + lapCoeff(i1,i2,i3,2)*( lap4h002i + ctt1*lap2h004i )     + lapCoeff(i1,i2,i3,3)*( lap4h110i + cr1*lap2h310i + cs1*lap2h130i ) + lapCoeff(i1,i2,i3,4)*( lap4h101i + cr1*lap2h301i + ct1*lap2h103i ) + lapCoeff(i1,i2,i3,5)*( lap4h011i + cs1*lap2h031i + ct1*lap2h013i ) + lapCoeff(i1,i2,i3,6)*( lap4h100i + cr1 *lap2h300i )    + lapCoeff(i1,i2,i3,7)*( lap4h010i + cs1 *lap2h030i )    + lapCoeff(i1,i2,i3,8)*( lap4h001i + ct1 *lap2h003i )      
                ...
                ! --- Modified equation space-time update ----
                                un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m)  + cdtsq*( lap6h )               + cdtPow4By12*( lap4hSq )       + cdtPow6By360*( lap2hCubed )   + dtSq*fv(m)                      
                            end if ! mask .ne. 0
                          end do
                          end do
                          end do
        ...
        !       #Elif "3" eq "3"
        !         ! stop 2222
        !         update3dOrder2Rectangular(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder2Curvilinear(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder2Curvilinear(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End        
        !     #End
        ...
        !     #If "curvilinear" eq "rectangular"
        !       #If "3" eq "2" 
        !         update2dOrder4Rectangular(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 747
        !         update3dOrder4Rectangular(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder4Curvilinear(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder4Curvilinear(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End        
        !     #End  
        ...
        !     #If "curvilinear" eq "rectangular"
        !       #If "3" eq "2" 
        !         update2dOrder6Rectangular(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 727
        !         update3dOrder6Rectangular(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder6Curvilinear(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder6Curvilinear(3,6,2,curvilinear)
        !       #Else
        ...
        !     #If "curvilinear" eq "rectangular"
        !       #If "3" eq "2" 
        !         update2dOrder8Rectangular(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 820
        !         update3dOrder8Rectangular(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder8Curvilinear(3,6,2,curvilinear)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder8Curvilinear(3,6,2,curvilinear)
        !       #Else
        !         stop 8888
        !       #End        
        !     #End  
        !   #Else
        !     write(*,'("advWaveME: error - no hierarchical ME scheme yet for dim=3 order=6 orderInTime=2, gridType=curvilinear")') 
        !     stop 6666
        !   #End
              else
                      if( ( .true. .or. debug.gt.3) .and. t.lt.2*dt )then
                          write(*,'("advWaveME: ADVANCE dim=3 order=6 orderInTime=6, grid=curvilinear... t=",e10.2)') t
                      end if
                      m=0 ! component number 
                      ec = 0 ! component number 
           ! -- call the appropriate macro:
           !  update2dOrder2Rectangular(3,6,6,curvilinear)
           !  update3dOrder6Curvilinear(3,6,6,curvilinear)
             ! ---- DEFINE CONSTANTS IN EXPANSIONS OF DERIVATIVES ----
             ! Example: 
             ! u.rr = D+D-( I + crr1*D+D- + crr2*(D+D-x)^2 + ...
cr0 = 1.; cr1 = -1/6.; cr2 = 1/30.; 
...
ctttt0 = 1.; ctttt1 = -1/6.; ctttt2 = 7/240.; 
         ...
         !       #Elif "3" eq "3"
         !         ! stop 2222
         !         update3dOrder2Rectangular(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder2Curvilinear(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder2Curvilinear(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End        
         !     #End
         ...
         !     #If "curvilinear" eq "rectangular"
         !       #If "3" eq "2" 
         !         update2dOrder4Rectangular(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 747
         !         update3dOrder4Rectangular(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder4Curvilinear(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder4Curvilinear(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End        
         !     #End  
         ...
         !     #If "curvilinear" eq "rectangular"
         !       #If "3" eq "2" 
         !         update2dOrder6Rectangular(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 727
         !         update3dOrder6Rectangular(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder6Curvilinear(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder6Curvilinear(3,6,6,curvilinear)
         !       #Else
         ...
         !     #If "curvilinear" eq "rectangular"
         !       #If "3" eq "2" 
         !         update2dOrder8Rectangular(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 820
         !         update3dOrder8Rectangular(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder8Curvilinear(3,6,6,curvilinear)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder8Curvilinear(3,6,6,curvilinear)
         !       #Else
         !         stop 8888
         !       #End        
         !     #End  
         !   #Else
         !     write(*,'("advWaveME: error - no hierarchical ME scheme yet for dim=3 order=6 orderInTime=6, gridType=curvilinear")') 
         !     stop 6666
         !   #End
              end if 
      else
