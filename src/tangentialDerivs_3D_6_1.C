...
d46=DERIV202(d24,wth,lth,dx);
d56=DERIV102(d44,wth,lth,dx);
d66=DERIV202(d44,wth,lth,dx);
...
Z[ind3(0,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d13+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d31+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d15+(-1.0/6.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d33+(1.0/30.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d51);
Z[ind3(0,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d23+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d41+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d25+(-1.0/12.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d43+(1.0/90.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d61);
Z[ind3(0,3,1,NU,MU,MU)] = d31+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d33+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d51+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d35+(-1.0/4.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d53);
Z[ind3(0,4,1,NU,MU,MU)] = d41+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d43+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d61+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d45+(-1.0/6.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d63);
...
Z[ind3(0,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d14+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d32+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d16+(-1.0/6.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d34+(1.0/30.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d52);
Z[ind3(0,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d24[J]+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d42[J]+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d26+(-1.0/12.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d44[J]+(1.0/90.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d62);
Z[ind3(0,3,2,NU,MU,MU)] = d32+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d34+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d52+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d36+(-1.0/4.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d54);
Z[ind3(0,4,2,NU,MU,MU)] = d42[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d44[J]+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d62+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d46+(-1.0/6.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d64);
...
Z[ind3(0,1,3,NU,MU,MU)] = d13+(1.0*(-1.0/6.0)*(1.0)*(dx[0]*dx[0])*d33+(-1.0/4.0)*1.0*(dx[2]*dx[2])*(1.0)*d15+1.0*(1.0/30.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d53+(-1.0/4.0)*(-1.0/6.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d35);
Z[ind3(0,2,3,NU,MU,MU)] = d23+(1.0*(-1.0/12.0)*(1.0)*(dx[0]*dx[0])*d43+(-1.0/4.0)*1.0*(dx[2]*dx[2])*(1.0)*d25+1.0*(1.0/90.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d63+(-1.0/4.0)*(-1.0/12.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d45);
Z[ind3(0,3,3,NU,MU,MU)] = d33+(1.0*(-1.0/4.0)*(1.0)*(dx[2]*dx[2])*d35+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d53);
Z[ind3(0,4,3,NU,MU,MU)] = d43+(1.0*(-1.0/4.0)*(1.0)*(dx[2]*dx[2])*d45+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d63);
...
Z[ind3(0,1,4,NU,MU,MU)] = d14+(1.0*(-1.0/6.0)*(1.0)*(dx[0]*dx[0])*d34+(-1.0/6.0)*1.0*(dx[2]*dx[2])*(1.0)*d16+1.0*(1.0/30.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d54+(-1.0/6.0)*(-1.0/6.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d36);
Z[ind3(0,2,4,NU,MU,MU)] = d24[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[0]*dx[0])*d44[J]+(-1.0/6.0)*1.0*(dx[2]*dx[2])*(1.0)*d26+1.0*(1.0/90.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d64+(-1.0/6.0)*(-1.0/12.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d46);
Z[ind3(0,3,4,NU,MU,MU)] = d34+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d36+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d54);
Z[ind3(0,4,4,NU,MU,MU)] = d44[J]+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d46+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d64);
...
Z[ind3(1,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d13+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d31+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d15+(-1.0/6.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d33+(1.0/30.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d51);
Z[ind3(1,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d23+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d41+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d25+(-1.0/12.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d43+(1.0/90.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d61);
Z[ind3(1,3,1,NU,MU,MU)] = d31+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d33+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d51+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d35+(-1.0/4.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d53);
Z[ind3(1,4,1,NU,MU,MU)] = d41+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d43+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d61+1.0*(1.0/30.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d45+(-1.0/6.0)*(-1.0/6.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d63);
...
Z[ind3(1,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d14+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d32+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d16+(-1.0/6.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d34+(1.0/30.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d52);
Z[ind3(1,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d24[J]+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d42[J]+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d26+(-1.0/12.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d44[J]+(1.0/90.0)*1.0*(dx[0]*dx[0]*dx[0]*dx[0])*(1.0)*d62);
Z[ind3(1,3,2,NU,MU,MU)] = d32+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d34+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d52+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d36+(-1.0/4.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d54);
Z[ind3(1,4,2,NU,MU,MU)] = d42[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d44[J]+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d62+1.0*(1.0/90.0)*(1.0)*(dx[2]*dx[2]*dx[2]*dx[2])*d46+(-1.0/6.0)*(-1.0/12.0)*(dx[0]*dx[0])*(dx[2]*dx[2])*d64);
...
Z[ind3(1,1,3,NU,MU,MU)] = d13+(1.0*(-1.0/6.0)*(1.0)*(dx[0]*dx[0])*d33+(-1.0/4.0)*1.0*(dx[2]*dx[2])*(1.0)*d15+1.0*(1.0/30.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d53+(-1.0/4.0)*(-1.0/6.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d35);
Z[ind3(1,2,3,NU,MU,MU)] = d23+(1.0*(-1.0/12.0)*(1.0)*(dx[0]*dx[0])*d43+(-1.0/4.0)*1.0*(dx[2]*dx[2])*(1.0)*d25+1.0*(1.0/90.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d63+(-1.0/4.0)*(-1.0/12.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d45);
Z[ind3(1,3,3,NU,MU,MU)] = d33+(1.0*(-1.0/4.0)*(1.0)*(dx[2]*dx[2])*d35+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d53);
Z[ind3(1,4,3,NU,MU,MU)] = d43+(1.0*(-1.0/4.0)*(1.0)*(dx[2]*dx[2])*d45+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d63);
...
Z[ind3(1,1,4,NU,MU,MU)] = d14+(1.0*(-1.0/6.0)*(1.0)*(dx[0]*dx[0])*d34+(-1.0/6.0)*1.0*(dx[2]*dx[2])*(1.0)*d16+1.0*(1.0/30.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d54+(-1.0/6.0)*(-1.0/6.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d36);
Z[ind3(1,2,4,NU,MU,MU)] = d24[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[0]*dx[0])*d44[J]+(-1.0/6.0)*1.0*(dx[2]*dx[2])*(1.0)*d26+1.0*(1.0/90.0)*(1.0)*(dx[0]*dx[0]*dx[0]*dx[0])*d64+(-1.0/6.0)*(-1.0/12.0)*(dx[2]*dx[2])*(dx[0]*dx[0])*d46);
Z[ind3(1,3,4,NU,MU,MU)] = d34+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d36+(-1.0/4.0)*1.0*(dx[0]*dx[0])*(1.0)*d54);
Z[ind3(1,4,4,NU,MU,MU)] = d44[J]+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d46+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d64);
...
Z[ind3(2,1,1,NU,MU,MU)] = d11+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d13+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d31);
Z[ind3(2,2,1,NU,MU,MU)] = d21+(1.0*(-1.0/6.0)*(1.0)*(dx[2]*dx[2])*d23+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d41);
...
Z[ind3(2,1,2,NU,MU,MU)] = d12+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d14+(-1.0/6.0)*1.0*(dx[0]*dx[0])*(1.0)*d32);
Z[ind3(2,2,2,NU,MU,MU)] = d22[J]+(1.0*(-1.0/12.0)*(1.0)*(dx[2]*dx[2])*d24[J]+(-1.0/12.0)*1.0*(dx[0]*dx[0])*(1.0)*d42[J]);
