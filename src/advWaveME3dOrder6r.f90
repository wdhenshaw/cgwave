! This file automatically generated from advWaveME.bf90 with bpp.
    subroutine advWaveME3dOrder6r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,fa,v,vh,lapCoeff,bc,frequencyArray,ipar,rpar,ierr )
  ! subroutine advWaveME3dOrder6r(nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,!                 mask,xy,rsxy,  um,u,un, f,fa, v, vh,  bc, frequencyArray, ipar, rpar, ierr )
 !======================================================================
     ...
     ! ------- EXPLIICT update the solution ---------
        ...
        ! FD26 : second-order in time and sixth-order in space
                    if( ( .true. .or. debug.gt.3) .and. t.lt.2*dt )then
                        write(*,'("advWaveME: ADVANCE dim=3 order=6 orderInTime=2, grid=rectangular... t=",e10.2)') t
                    end if
                    m=0 ! component number 
                    ec = 0 ! component number 
          ! -- call the appropriate macro:
          !  update2dOrder2Rectangular(3,6,2,rectangular)
          !  update3dOrder6Curvilinear(3,6,2,rectangular)
...
czz=1./dx(2)**2;
            ...
            ! ===========  FINAL LOOP TO FILL IN THE SOLUTION ============
                ...
                ! --- Laplacian to order 6 = lap4h + corrections 
                                lap6h = lap4h(i1,i2,i3,0) + cxx*cxx2*d600i + cyy*cyy2*d060i + czz*czz2*d006i   
                                ...
                                lap2hCubed =                    cxx*lap2hSq200i  + cyy*lap2hSq020i  + czz*lap2hSq020i    
                ...
                !  lap2h*( lap4h ) + corrections*( Lap2h )
                                ...
                                lap4hSq =                                       cxx*( lap4h200i + cxx1*lap2h400i )  + cyy*( lap4h020i + cyy1*lap2h040i )  + czz*( lap4h002i + czz1*lap2h004i )    
        ...
        !       #Elif "3" eq "3"
        !         ! stop 2222
        !         update3dOrder2Rectangular(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder2Curvilinear(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder2Curvilinear(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End        
        !     #End
        ...
        !     #If "rectangular" eq "rectangular"
        !       #If "3" eq "2" 
        !         update2dOrder4Rectangular(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 747
        !         update3dOrder4Rectangular(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder4Curvilinear(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder4Curvilinear(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End        
        !     #End  
        ...
        !     #If "rectangular" eq "rectangular"
        !       #If "3" eq "2" 
        !         update2dOrder6Rectangular(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 727
        !         update3dOrder6Rectangular(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder6Curvilinear(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder6Curvilinear(3,6,2,rectangular)
        !       #Else
        ...
        !     #If "rectangular" eq "rectangular"
        !       #If "3" eq "2" 
        !         update2dOrder8Rectangular(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 820
        !         update3dOrder8Rectangular(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End
        !     #Else
        !       #If "3" eq "2" 
        !         update2dOrder8Curvilinear(3,6,2,rectangular)
        !       #Elif "3" eq "3"
        !         ! stop 7474
        !         update3dOrder8Curvilinear(3,6,2,rectangular)
        !       #Else
        !         stop 8888
        !       #End        
        !     #End  
        !   #Else
        !     write(*,'("advWaveME: error - no hierarchical ME scheme yet for dim=3 order=6 orderInTime=2, gridType=rectangular")') 
        !     stop 6666
        !   #End
              else
                      if( ( .true. .or. debug.gt.3) .and. t.lt.2*dt )then
                          write(*,'("advWaveME: ADVANCE dim=3 order=6 orderInTime=6, grid=rectangular... t=",e10.2)') t
                      end if
                      m=0 ! component number 
                      ec = 0 ! component number 
           ! -- call the appropriate macro:
           !  update2dOrder2Rectangular(3,6,6,rectangular)
           !  update3dOrder6Curvilinear(3,6,6,rectangular)
             ! ---- DEFINE CONSTANTS IN EXPANSIONS OF DERIVATIVES ----
             ! Example: 
             ! u.xx = D+D-( I + cxx1*D+D- + cxx2*(D+D-x)^2 + ...
cx0 = 1.; cx1 = -1/6.; cx2 = 1/30.; 
...
czz=1./dx(2)**2;
         ...
         !       #Elif "3" eq "3"
         !         ! stop 2222
         !         update3dOrder2Rectangular(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder2Curvilinear(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder2Curvilinear(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End        
         !     #End
         ...
         !     #If "rectangular" eq "rectangular"
         !       #If "3" eq "2" 
         !         update2dOrder4Rectangular(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 747
         !         update3dOrder4Rectangular(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder4Curvilinear(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder4Curvilinear(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End        
         !     #End  
         ...
         !     #If "rectangular" eq "rectangular"
         !       #If "3" eq "2" 
         !         update2dOrder6Rectangular(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 727
         !         update3dOrder6Rectangular(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder6Curvilinear(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder6Curvilinear(3,6,6,rectangular)
         !       #Else
         ...
         !     #If "rectangular" eq "rectangular"
         !       #If "3" eq "2" 
         !         update2dOrder8Rectangular(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 820
         !         update3dOrder8Rectangular(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End
         !     #Else
         !       #If "3" eq "2" 
         !         update2dOrder8Curvilinear(3,6,6,rectangular)
         !       #Elif "3" eq "3"
         !         ! stop 7474
         !         update3dOrder8Curvilinear(3,6,6,rectangular)
         !       #Else
         !         stop 8888
         !       #End        
         !     #End  
         !   #Else
         !     write(*,'("advWaveME: error - no hierarchical ME scheme yet for dim=3 order=6 orderInTime=6, gridType=rectangular")') 
         !     stop 6666
         !   #End
              end if 
      else
