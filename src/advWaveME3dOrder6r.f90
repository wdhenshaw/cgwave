! This file automatically generated from advWaveME.bf90 with bpp.
  subroutine advWaveME3dOrder6r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
...
czzzzzz0 = 1./(dx(2)**6); czzzzzz1 = (-1/4.); czzzzzz2 = (13/240.); 
              fv(m)=0.
               ...
               do i1=n1a,n1b
                  ...
                  un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtsq*( uxx + uyy +uzz ) + cdtPow4By12*( uxxxx + uyyyy + uzzzz + 2.*(uxxyy+uxxzz+uyyzz) )  + cdtPow6By360*( uxxxxxx + uyyyyyy + uzzzzzz + 3.*( uxxxxyy + uxxyyyy + uxxxxzz + uxxzzzz + uyyyyzz + uyyzzzz ) + 6.*(  uxxyyzz  ) ) +dtSq*fv(m)  
               end do
               end do
               end do
          else
