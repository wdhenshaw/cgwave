! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave2dOrder6r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE dim=2 order=6 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
                   ...
                   ! ---- SIXTH 6 ---
                     ! --- SIXTH-6 TWO DIMENSIONS ---
                       ! orderInSpace==6 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( uxx62r(i1,i2,i3,m) + uyy62r(i1,i2,i3,m) ) 
               ...
               ! #End
                   ...
                   ! ---- SIXTH 6 ---
                     ! --- SIXTH-6 TWO DIMENSIONS ---
                       ! orderInSpace==6 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( uxx62r(i1,i2,i3,m) + uyy62r(i1,i2,i3,m) ) +cf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                 if( (orderOfAccuracy.eq.6 .or. debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE dim=2 order=6 orderInTime=6, grid=rectangular... t=",e10.2)') t
                 end if
                 ! --- TAYLOR TIME-STEPPING --- 
                 m=0 ! component number 
                 ec = 0 ! component number
                    ...
                    ! ---- SIXTH 6 ---
                      ! --- SIXTH-6 TWO DIMENSIONS ---
                        ! ---- MODIFIED EQUATION 6=6 2D -----
                         ...
                         stop 6666
                        ! getSixthDerivatives2d(6,rectangular,evalMetrics,i1,i2,i3)
                        if( i1.eq.21 .and. i2.eq.11 )then
                            call ogDeriv(ep, 0,2,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxx(0) )
                            call ogDeriv(ep, 0,0,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evyy(0) )
                            call ogDeriv(ep, 0,4,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxxxx(0) )
                            call ogDeriv(ep, 0,0,4,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evyyyy(0) )
                            call ogDeriv(ep, 0,2,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxxyy(0) )
               ...
               ! uxxxx    = rxi**4*urrrr+4.*rxi**3*sxi*urrrs+6.*rxi**2*sxi**2*urrss+4.*rxi*sxi**3*ursss+sxi**4*ussss+6.*rxi**2*rxx*urrr+(7.*sxi*rxi*rxx+sxx*rxi**2+rxi*(3.*rxi*sxx+3.*rxx*sxi)+rxi*(2.*rxi*sxx+2.*rxx*sxi))*urrs+(sxi*(3.*rxi*sxx+3.*rxx*sxi)+7.*rxi*sxx*sxi+rxx*sxi**2+sxi*(2.*rxi*sxx+2.*rxx*sxi))*urss+6.*sxi**2*sxx*usss+(4.*rxi*rxxx+3.*rxx**2)*urr+(4.*rxi*sxxx+6.*rxx*sxx+4.*rxxx*sxi)*urs+(4.*sxi*sxxx+3.*sxx**2)*uss+rxxxx*ur+sxxxx*us
                        ...
                        un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( uxx + uyy ) + cdtPow4By12*( uxxxx + uyyyy + 2.*uxxyy )  + cdtPow6By360*( uxxxxxx + uyyyyyy + 3.*(uxxxxyy + uxxyyyy) ) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! uxxxx    = rxi**4*urrrr+4.*rxi**3*sxi*urrrs+6.*rxi**2*sxi**2*urrss+4.*rxi*sxi**3*ursss+sxi**4*ussss+6.*rxi**2*rxx*urrr+(7.*sxi*rxi*rxx+sxx*rxi**2+rxi*(3.*rxi*sxx+3.*rxx*sxi)+rxi*(2.*rxi*sxx+2.*rxx*sxi))*urrs+(sxi*(3.*rxi*sxx+3.*rxx*sxi)+7.*rxi*sxx*sxi+rxx*sxi**2+sxi*(2.*rxi*sxx+2.*rxx*sxi))*urss+6.*sxi**2*sxx*usss+(4.*rxi*rxxx+3.*rxx**2)*urr+(4.*rxi*sxxx+6.*rxx*sxx+4.*rxxx*sxi)*urs+(4.*sxi*sxxx+3.*sxx**2)*uss+rxxxx*ur+sxxxx*us
                        ...
                        ! cdtPow4By12  = (c*dt)^4/12 
                        ! cdtPow6By360 = (c*dt)^6/360
                        un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( uxx + uyy ) + cdtPow4By12*( uxxxx + uyyyy + 2.*uxxyy )  + cdtPow6By360*( uxxxxxx + uyyyyyy + 3.*(uxxxxyy + uxxyyyy) ) +cf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE SUPERGRID dim=2 order=6 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
                ! --- TAYLOR TIME-STEPPING --- 
                m=0 ! component number 
                ec = 0 ! component number
               ...
               ! #End
                   ! ---- SIXTH 6 ---
                     ! --- SIXTH-6 TWO DIMENSIONS ---
                      ...
                      un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx62r(i1,i2,i3,0) + etax(i1,1)*ux62r(i1,i2,i3,0)   + etay(i2,0)*uyy62r(i1,i2,i3,0) + etay(i2,1)*uy62r(i1,i2,i3,0) )                                                                         
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! #End
                   ...
                   ! ---- SIXTH 6 ---
                     ! --- SIXTH-6 TWO DIMENSIONS ---
                      ! 2D, orderInSpace==6 and orderInTime==2
                      un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx62r(i1,i2,i3,0) + etax(i1,1)*ux62r(i1,i2,i3,0)   + etay(i2,0)*uyy62r(i1,i2,i3,0) + etay(i2,1)*uy62r(i1,i2,i3,0) ) +tsf*fv(m)                                                                        
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                 if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE SUPERGRID dim=2 order=6 orderInTime=6, grid=rectangular... t=",e10.2)') t
                 end if
                 ! --- TAYLOR TIME-STEPPING --- 
                 m=0 ! component number 
                 ec = 0 ! component number
                ...
                ! #End
                    ! ---- SIXTH 6 ---
                      ! --- SIXTH-6 TWO DIMENSIONS ---
                        ...
                        ! cdtPow4By12  = (c*dt)^4/12 
                        ! cdtPow6By360 = (c*dt)^6/360
                        ! un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) !                 + cdtSq*( uxx + uyy ) !                 + cdtPow4By12*( uxxxx + uyyyy + 2.*uxxyy )  !                 + cdtPow6By360*( uxxxxxx + uyyyyyy + 3.*(uxxxxyy + uxxyyyy) ) !                 FV(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
         ...
         if( takeImplicitFirstStep.eq.1 )then
           if( orderInTime.eq.2 )then
             ...
             if( (debug.gt.3) .and. t.lt.2*dt )then
               write(*,'("advWave: ADVANCE IMPLICIT dim=2 order=6 orderInTime=6, grid=rectangular, t=",e10.2)') t
             end if
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
             if( (.true. .or. debug.gt.3) .and. t.lt.2*dt )then
               write(*,'("addUpwindDissImplicit: UPWIND DISS dim=2 order=6 grid=rectangular... t=",e10.2)') t
       ...
       if( preComputeUpwindUt.eq.1 )then
         ! precompute Ut in upwind dissipation,  (uses v=uDot computed above)
           if( debug.gt.3 .and. t.lt.4*dt )then
             write(*,'("addUpwindDiss: UPWIND DISS using u.t=v dim=2 order=6 grid=rectangular... t=",e10.2)') t
             write(*,'(" adxSosup=",3e12.4)') adxSosup(0), adxSosup(1),adxSosup(2)
           end if
           m=0 ! component number 
           ec = 0 ! component number
           ...
           ! beginLoops(i1,i2,i3,n1a,n1b,n2a,n2b,n3a,n3b)
             ...
             do i1=n1a,n1b
              ...
              ! ---- SIXTH 6 ---
                ! --- TWO DIMENSIONS ---
                  un(i1,i2,i3,ec)=un(i1,i2,i3,ec)+(-70.*v(i1,i2,i3,ec)+56.*(v(i1+1,i2,i3,ec)+v(i1-1,i2,i3,ec))-28.*(v(i1+2,i2,i3,ec)+v(i1-2,i2,i3,ec))+8.*(v(i1+3,i2,i3,ec)+v(i1-3,i2,i3,ec))-(v(i1+4,i2,i3,ec)+v(i1-4,i2,i3,ec)))*adxSosup(0)+(-70.*v(i1,i2,i3,ec)+56.*(v(i1,i2+1,i3,ec)+v(i1,i2-1,i3,ec))-28.*(v(i1,i2+2,i3,ec)+v(i1,i2-2,i3,ec))+8.*(v(i1,i2+3,i3,ec)+v(i1,i2-3,i3,ec))-(v(i1,i2+4,i3,ec)+v(i1,i2-4,i3,ec)))*adxSosup(1)
               end if
             end do
             end do
             end do
         ...
         ! compute Ut inline in Gauss-Seidel fashion (this is more stable)
           if( debug.gt.3 .and. t.lt.4*dt )then
             write(*,'("addUpwindDiss: UPWIND DISS using u.t=Dztu dim=2 order=6 grid=rectangular... t=",e10.2)') t
             write(*,'(" adxSosup=",3e12.4)') adxSosup(0), adxSosup(1),adxSosup(2)
           end if
           m=0 ! component number 
           ec = 0 ! component number
