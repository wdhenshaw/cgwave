                      ...
                      // --- ghost line 2 ---
                        ...
                        // const bool useCBC = timeSteppingMethod==CgWave::implicitTimeStepping; // currently explicit EM order 4 uses extrap5
                          ...
                          // The CBC for EM2 at order 4 uses a one-sided approx to u.xxyy
                                                    ...
                                                    int ks1=0, ks2=0; // centered stencil
                                                    if( useOneSidedXXYY ){ ks1=is1; ks2=is2; } // shift stencil 
                                                    Real maxResCBC1 =0.;
                                                    Real maxResCBC2 =0.;            
                                                    ...
                                                    {        
                                                        ...
                                                        uxxyy(Ib1,Ib2,Ib3,R2) = ( 
                                                                                    vLocal(Ib1-1+ks1,Ib2-1+ks2,Ib3,R2)  
                                                                                  +vLocal(Ib1+1+ks1,Ib2-1+ks2,Ib3,R2)  
                                                                            -2.*vLocal(Ib1  +ks1,Ib2-1+ks2,Ib3,R2)  
                                                                            -2.*vLocal(Ib1-1+ks1,Ib2  +ks2,Ib3,R2) 
                                                                            +4.*vLocal(Ib1  +ks1,Ib2  +ks2,Ib3,R2) 
                                                                            -2.*vLocal(Ib1+1+ks1,Ib2  +ks2,Ib3,R2) 
                                                                            -2.*vLocal(Ib1  +ks1,Ib2+1+ks2,Ib3,R2)
                                                                                  +vLocal(Ib1-1+ks1,Ib2+1+ks2,Ib3,R2)  
                                                                                  +vLocal(Ib1+1+ks1,Ib2+1+ks2,Ib3,R2)  
                                                                        )/(dx[0]*dx[0]*dx[1]*dx[1]);            
                                                        if( true && useOneSidedXXYY )
                                                        {
                              // check for corners and shift stencil inward
                                                            int iv[3], &i1=iv[0], &i2=iv[1], &i3=iv[2];
                                                            const int axisp1 = (axis+1) % mg.numberOfDimensions(); // adjacent axis 
                                                            for( int side2=0; side2<=1 ; side2++ )
                                                            {
                                                                if( mg.boundaryCondition(side2,axisp1)>0 )
                                                                {
