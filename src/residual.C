...
#define FOR_3DN(i1,i2,i3,n,I1,I2,I3,N) for( int n=N.getBase(); n<=N.getBound(); n++ ) for( int i3=I3.getBase(); i3<=I3.getBound(); i3++ )  for( int i2=I2.getBase(); i2<=I2.getBound(); i2++ )  for( int i1=I1.getBase(); i1<=I1.getBound(); i1++ )
