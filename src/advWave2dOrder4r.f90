! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave2dOrder4r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,pdb,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
             ...
             if( addForcing.eq.0 )then
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap2d4(i1,i2,i3,m) 
               ...
               ! #End
                    if( addForcing.eq.0 )then
                      ...
                      if( damp.ne.0. )then
                            call ogDeriv(ep, 1,0,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evt(m) )
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ! orderInSpace==4 and orderInTime==2                                                   
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap2d4(i1,i2,i3,m) +cf*fv(m)
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap2d4(i1,i2,i3,m) + cLapSq*lap2d2pow2(i1,i2,i3,m) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! orderInSpace=4 and orderInTime=4 
                          un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*lap2d4(i1,i2,i3,m) + cLapSq*lap2d2pow2(i1,i2,i3,m) +cf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
            ...
            ! FD26 : second-order in time and sixth-order in space
             if( addForcing.eq.0 )then
                if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE SUPERGRID dim=2 order=4 orderInTime=2, grid=rectangular... t=",e10.2)') t
                end if
                ! --- TAYLOR TIME-STEPPING --- 
                m=0 ! component number 
                ec = 0 ! component number
               ...
               ! #End
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ...
                       un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) )                                                             
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ! 2D orderInSpace==4 and orderInTime==2
                       un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) ) +cf*fv(m)                                                            
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
             ...
             if( addForcing.eq.0 )then
                 if( (orderOfAccuracy.eq.2 .or. debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE SUPERGRID dim=2 order=4 orderInTime=4, grid=rectangular... t=",e10.2)') t
                 end if
                 ! --- TAYLOR TIME-STEPPING --- 
                 m=0 ! component number 
                 ec = 0 ! component number
                     ...
                     if( useSuperGrid==0 )then
                       ...
                       ! superGrid -- **Cartesian Grid**
                         ...
                         do i2=m2a,m2b
                         do i1=m1a,m1b
                         v(i1,i2,i3,0) =  etax(i1,0)*uxx22r(i1,i2,i3,0) + etax(i1,1)*ux22r(i1,i2,i3,0) + etay(i2,0)*uyy22r(i1,i2,i3,0) + etay(i2,1)*uy22r(i1,i2,i3,0)
                         ! v(i1,i2,i3,0) = uxx22(i1,i2,i3,0) + uyy22(i1,i2,i3,0)
                         end do
                         end do
                         end do
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! 2D, orderInSpace=4 and orderInTime=4 
                         ...
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) ) + cdtsq12*( etax(i1,0)*vxx22r(i1,i2,i3,0) + etax(i1,1)*vx22r(i1,i2,i3,0)   + etay(i2,0)*vyy22r(i1,i2,i3,0) + etay(i2,1)*vy22r(i1,i2,i3,0) ) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! 2D, orderInSpace=4 and orderInTime=4 
                         ! v is assumed to hold Lap(u) to 2nd-order
                         un(i1,i2,i3,m)= cn*u(i1,i2,i3,m) +cm*um(i1,i2,i3,m) + cLap*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) ) + cdtsq12*( etax(i1,0)*vxx22r(i1,i2,i3,0) + etax(i1,1)*vx22r(i1,i2,i3,0)   + etay(i2,0)*vyy22r(i1,i2,i3,0) + etay(i2,1)*vy22r(i1,i2,i3,0) ) +cf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                   ...
                   do i1=n1a,n1b
                     ...
                     if( addForcing.eq.0 )then ! *wdh* Tues March 28, 2023
                       ...
                       if( damp .ne. 0. )then
                         ...
                         do mt=-1,1
                           tm = t + dt*mt
                             call ogDeriv(ep, 0,4,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,tm, ec,evxxxx(m) )
                             call ogDeriv(ep, 0,2,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,tm, ec,evxxyy(m) )
                             call ogDeriv(ep, 0,0,4,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,tm, ec,evyyyy(m) )
                         ...
                         if( takeImplicitFirstStep.eq.1 )then
                           ...
                           ! dt^3/6 * f_t 
                           !  f_t = ue_ttt - L ue_t
                             call ogDeriv(ep, 3,0,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evttt(m) )
                             call ogDeriv(ep, 1,2,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxxt(m) )
                             call ogDeriv(ep, 1,0,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evyyt(m) )
                           fv(m) = fv(m) + (1./cf)*(dt**3/6.)*( evttt(m) - cSq*( evxxt(m) + evyyt(m) )) 
                           ! -alpha2 * dt^5/6 *( L f_t )
                           ! L f_t = (L ue)_ttt - L^2(ue)_t 
                             call ogDeriv(ep, 3,2,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxxttt(m) )
                             call ogDeriv(ep, 3,0,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evyyttt(m) )
                             call ogDeriv(ep, 1,4,0,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxxxxt(m) )
                             call ogDeriv(ep, 1,2,2,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evxxyyt(m) )
                             call ogDeriv(ep, 1,0,4,0, xy(i1,i2,i3,0),xy(i1,i2,i3,1),0.,t, ec,evyyyyt(m) )
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- TWO DIMENSIONS ---
                        ! 2D orderInSpace=4 and orderInTime=4 IMPLICIT
                          ! FD44 IMP RECT 2D
                          un(i1,i2,i3,m)= ts1*u(i1,i2,i3,m) +ts2*um(i1,i2,i3,m) + ts3*( uxx42r(i1,i2,i3,0) +  uyy42r(i1,i2,i3,0) )  + ts4*(umxx42r(i1,i2,i3,0) + umyy42r(i1,i2,i3,0) )  + ts5*( (6.*u(i1,i2,i3,0)-4.*(u(i1+1,i2,i3,0)+u(i1-1,i2,i3,0))+(u(i1+2,i2,i3,0)+u(i1-2,i2,i3,0)))*dxi4+(6.*u(i1,i2,i3,0)-4.*(u(i1,i2+1,i3,0)+u(i1,i2-1,i3,0))+(u(i1,i2+2,i3,0)+u(i1,i2-2,i3,0)))*dyi4+(8.*u(i1,i2,i3,0)-4.*(u(i1+1,i2,i3,0)+u(i1-1,i2,i3,0)+u(i1,i2+1,i3,0)+u(i1,i2-1,i3,0))+2.*(u(i1+1,i2+1,i3,0)+u(i1-1,i2+1,i3,0)+u(i1+1,i2-1,i3,0)+u(i1-1,i2-1,i3,0)))*dxdyi2 ) + ts6*( (6.*um(i1,i2,i3,0)-4.*(um(i1+1,i2,i3,0)+um(i1-1,i2,i3,0))+(um(i1+2,i2,i3,0)+um(i1-2,i2,i3,0)))*dxi4+(6.*um(i1,i2,i3,0)-4.*(um(i1,i2+1,i3,0)+um(i1,i2-1,i3,0))+(um(i1,i2+2,i3,0)+um(i1,i2-2,i3,0)))*dyi4+(8.*um(i1,i2,i3,0)-4.*(um(i1+1,i2,i3,0)+um(i1-1,i2,i3,0)+um(i1,i2+1,i3,0)+um(i1,i2-1,i3,0))+2.*(um(i1+1,i2+1,i3,0)+um(i1-1,i2+1,i3,0)+um(i1+1,i2-1,i3,0)+um(i1-1,i2-1,i3,0)))*dxdyi2 ) + tsf*fv(m)                                                               
             ...
             if( orderOfAccuracy.eq.4 .and. orderInTime.eq.2 )then
              ! FD24 : second-order in time and fourth-order in space
                if( (debug.gt.3) .and. t.lt.2*dt )then
                  write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=2 order=4 orderInTime=2, grid=rectangular, t=",e10.2)') t
                end if
                ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                m=0 ! component number 
                ...
                !   #If "4" eq "4" && "2" eq "4"
                !     computeLaplacianOrder2(2,IMPLICIT)
                !   #End
                ! #End
                if( forcingOption.eq.helmholtzForcing .and. addForcing.ne.0 )then
                  do freq=0,numberOfFrequencies-1
                ...
                fv(m)=0.
                 ...
                 if( (debug.gt.3) .and. t.lt.2*dt )then
                   write(*,'("advWave: ADVANCE IMPLICIT SUPERGRID dim=2 order=4 orderInTime=4, grid=rectangular, t=",e10.2)') t
                 end if
                 ! --- IMPLICIT TAYLOR TIME-STEPPING --- 
                 !  D+t D-t u = c^2 Delta( cImp(1) *u^{n+1} + cImp(0) *u^n + cImp(-1)* u^{n-1} )
                 m=0 ! component number 
                 ...
                 fv(m)=0.
                   ...
                   do i1=n1a,n1b
                    ...
                    stop 5555
                      ! --- TWO DIMENSIONS ---
                        ! 2D orderInSpace=4 and orderInTime=4 IMPLICIT
                          write(*,'("advWave: finish me for rectangular IMPLICIT order=4, dim=2")')
                          stop 4444
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
           if( useSuperGrid==1 .and. gridType==curvilinear )then
             ...
             ! addUpwindDissImplicitOld(2,4,rectangular)
               if( (.true. .or. debug.gt.3) .and. t.lt.4*dt )then
                 write(*,'(/,"advWave:addUpwindDissImplicit: UPWIND DISS dim=2 order=4 grid=rectangular... t=",e10.2)') t
                 if( gridType==rectangular )then
               ...
               if(  solveHelmholtz==1 .and. adjustHelmholtzForUpwinding==1 )then
                 ...
                 ! Note minus sign 
                     un(i1,i2,i3,ec) = un(i1,i2,i3,ec) - ((-20.*um(i1,i2,i3,ec)+15.*(um(i1+1,i2,i3,ec)+um(i1-1,i2,i3,ec))-6.*(um(i1+2,i2,i3,ec)+um(i1-2,i2,i3,ec))+(um(i1+3,i2,i3,ec)+um(i1-3,i2,i3,ec)))*adxSosup(0)+(-20.*um(i1,i2,i3,ec)+15.*(um(i1,i2+1,i3,ec)+um(i1,i2-1,i3,ec))-6.*(um(i1,i2+2,i3,ec)+um(i1,i2-2,i3,ec))+(um(i1,i2+3,i3,ec)+um(i1,i2-3,i3,ec)))*adxSosup(1))
                   end if
                 end do
                 end do
                 end do
           ...
           ! precompute Ut in upwind dissipation,  (uses v=uDot computed above)
             ...
             ! beginLoops(i1,i2,i3,n1a,n1b,n2a,n2b,n3a,n3b)
               ...
               do i1=n1a,n1b
                ...
                ! --- -FOURTH 4 ---
                  ! --- TWO DIMENSIONS ---
                    un(i1,i2,i3,ec)=un(i1,i2,i3,ec)+((-20.*v(i1,i2,i3,ec)+15.*(v(i1+1,i2,i3,ec)+v(i1-1,i2,i3,ec))-6.*(v(i1+2,i2,i3,ec)+v(i1-2,i2,i3,ec))+(v(i1+3,i2,i3,ec)+v(i1-3,i2,i3,ec)))*adxSosup(0)+(-20.*v(i1,i2,i3,ec)+15.*(v(i1,i2+1,i3,ec)+v(i1,i2-1,i3,ec))-6.*(v(i1,i2+2,i3,ec)+v(i1,i2-2,i3,ec))+(v(i1,i2+3,i3,ec)+v(i1,i2-3,i3,ec)))*adxSosup(1))
                 end if
               end do
               end do
               end do
           ...
           ! compute Ut inline in Gauss-Seidel fashion (this is more stable)
             ...
             ! beginLoops(i1,i2,i3,n1a,n1b,n2a,n2b,n3a,n3b)
               ...
               do i1=n1a,n1b
                ...
                ! --- -FOURTH 4 ---
                  ! --- TWO DIMENSIONS ---
                    un(i1,i2,i3,ec)=un(i1,i2,i3,ec)+((-20.*Dztu(i1,i2,i3,ec)+15.*(Dztu(i1+1,i2,i3,ec)+Dztu(i1-1,i2,i3,ec))-6.*(Dztu(i1+2,i2,i3,ec)+Dztu(i1-2,i2,i3,ec))+(Dztu(i1+3,i2,i3,ec)+Dztu(i1-3,i2,i3,ec)))*adxSosup(0)+(-20.*Dztu(i1,i2,i3,ec)+15.*(Dztu(i1,i2+1,i3,ec)+Dztu(i1,i2-1,i3,ec))-6.*(Dztu(i1,i2+2,i3,ec)+Dztu(i1,i2-2,i3,ec))+(Dztu(i1,i2+3,i3,ec)+Dztu(i1,i2-3,i3,ec)))*adxSosup(1))
                 end if
               end do
               end do
               end do
