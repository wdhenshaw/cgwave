! This file automatically generated from advWave.bf90 with bpp.
    subroutine advWave2dOrder4r( nd,n1a,n1b,n2a,n2b,n3a,n3b,nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,mask,xy,rsxy,um,u,un,f,stencilCoeff,v,vh,lapCoeff,etax,etay,etaz,bc,frequencyArray,ipar,rpar,ierr )
   !======================================================================
       ...
       if( gridIsImplicit.eq.0 )then 
             ...
             if( addForcing.eq.0 )then
               ...
               ! #End
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ...
                       un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) )                                                             
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
               ...
               ! #End
                   ...
                   ! --- -FOURTH 4 ---
                     ! --- FOUTH-4 TWO DIMENSIONS ---
                       ! 2D orderInSpace==4 and orderInTime==2
                       un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) ) +tsf*fv(m)                                                            
                 ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                 ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                 ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                 ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! 2D, orderInSpace=4 and orderInTime=4 
                         ...
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) ) + cdtsq12*( etax(i1,0)*vxx22r(i1,i2,i3,0) + etax(i1,1)*vx22r(i1,i2,i3,0)   + etay(i2,0)*vyy22r(i1,i2,i3,0) + etay(i2,1)*vy22r(i1,i2,i3,0) ) 
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
                ...
                ! #End
                    ...
                    ! --- -FOURTH 4 ---
                      ! --- FOUTH-4 TWO DIMENSIONS ---
                        ! 2D, orderInSpace=4 and orderInTime=4 
                         ! v is assumed to hold Lap(u) to 2nd-order
                         un(i1,i2,i3,m)= 2.*u(i1,i2,i3,m)-um(i1,i2,i3,m) + cdtSq*( etax(i1,0)*uxx42r(i1,i2,i3,0) + etax(i1,1)*ux42r(i1,i2,i3,0)   + etay(i2,0)*uyy42r(i1,i2,i3,0) + etay(i2,1)*uy42r(i1,i2,i3,0) ) + cdtsq12*( etax(i1,0)*vxx22r(i1,i2,i3,0) + etax(i1,1)*vx22r(i1,i2,i3,0)   + etay(i2,0)*vyy22r(i1,i2,i3,0) + etay(i2,1)*vy22r(i1,i2,i3,0) ) +tsf*fv(m)
                  ! write(*,'("i1,i2=",2i3," u-ue=",e10.2)') i1,i2,u(i1,i2,i3,m)-ev(m)
                  ! write(*,'(" uxx-uxxe =",e10.2)') uxx22r(i1,i2,i3,0)-evxx(m)
                  ! OGDERIV2D( 0,0,0,0,i1,i2,i3,t+dt, ec, ev(m)  )
                  ! write(*,'(" un-ue=",e10.2)') un(i1,i2,i3,m)-ev(m)
         ...
         if( useImplicitUpwindDissipation.eq.1 )then
             if( (.true. .or. debug.gt.3) .and. t.lt.2*dt )then
               write(*,'("addUpwindDissImplicit: UPWIND DISS dim=2 order=4 grid=rectangular... t=",e10.2)') t
